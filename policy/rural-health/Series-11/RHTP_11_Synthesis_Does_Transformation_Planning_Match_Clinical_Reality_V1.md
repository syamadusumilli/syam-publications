...
**11A Disease Burden:** Foundational mortality data establishing treatable conditions as primary drivers of rural excess death.

**11B Specialty Gap:** Analysis of specialist maldistribution and economic impossibility of local specialist presence.

**11C Mental Health and Despair:** Examination of deaths of despair and the limits of clinical response to structural devastation.

**11D Chronic Disease and Prevention:** Assessment of prevention failure despite decades of programming investment.

**11E Maternal and Child Health:** Documentation of maternity care deserts and obstetric closure cascade.

**11F Oral Health and the Dental Desert:** Analysis of oral health exclusion from healthcare policy.

**11-TD-A Disease Burden Atlas:** Comprehensive data reference for mortality and morbidity by region.

**3.KY Kentucky Analysis:** State-level examination of priority alignment and implementation assessment.

**4G Behavioral Health Integration:** Evidence base for collaborative care and behavioral health approaches.

**5.Synthesis State Agency Structures:** Analysis of which agency structures support transformation.

**12A Coverage Erosion:** Policy context for understanding clinical consequences of coverage loss.
...
Kentucky Cabinet for Health and Family Services. "Rural Health Transformation Program Application." Commonwealth of Kentucky, 2025.

March of Dimes. "Nowhere to Go: Maternity Care Deserts Across the US." Report No. 4, 2024, marchofdimes.org/peristats/reports/united-states/maternity-care-deserts.

Nolte, Ellen, and C. Martin McKee. "In Amenable Mortality: Deaths Avoidable Through Health Care: Progress in the US Lags That of Three European Countries." *Health Affairs*, vol. 31, no. 9, 2012, pp. 2114-22.
