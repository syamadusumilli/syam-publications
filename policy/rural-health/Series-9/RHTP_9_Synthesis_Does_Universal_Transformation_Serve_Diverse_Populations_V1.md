...
*Series 9: Special Populations (Capstone)*
...
| Population | Core Tension Examined | Universal Approach Adequacy | Critical Accommodation Required |
|------------|----------------------|----------------------------|--------------------------------|
| **Rural Elderly** | Current vs. Infrastructure | Moderate | Geriatric workforce, aging infrastructure sustainability |
| **Tribal/Indigenous** | Separate vs. Integration | Low | Sovereignty respect, IHS coordination, government-to-government relationships |
| **Frontier** | Universal vs. Extreme | Low | Alternative delivery models, Community Health Aide, telehealth-primary |
| **Farmworkers** | Visibility vs. Need | Very Low | Portability, documentation-sensitivity, occupational health, mobile infrastructure |
| **Persistent Poverty** | Current vs. Intergenerational | Low | SDOH integration, economic development linkage, long-term commitment |
| **Post-Industrial** | Resilience vs. Barriers | Moderate | Economic transition recognition, community asset building |
| **Black Belt/Delta** | Characteristics vs. Discrimination | Low | Equity-focused investment, historical discrimination accountability |
| **Appalachian** | Resilience vs. Barriers | Moderate | Community-controlled design, structural focus over deficit framing |
| **Border** | Universal vs. Binational | Low | Cross-border recognition, binational coordination, documentation-sensitivity |
| **Veterans** | Separate vs. Integration | Moderate | VA coordination, military trauma training, telehealth bridges |
| **Rural Children** | Current vs. Future | Moderate | Pediatric access, family support, developmental services |
| **Justice-Involved** | Visibility vs. Need | Very Low | Transition continuity, Medicaid pre-release enrollment, MAT continuation |
| **Substance Use Disorder** | Characteristics vs. System | Low | MAT expansion, harm reduction acceptance, workforce development |
| **Serious Mental Illness** | Separate vs. Integration | Low | Specialty access, crisis services, ACT teams, workforce pipeline |
| **Complex Conditions** | Universal vs. Specialty | Low | Hub-and-spoke networks, travel support, care coordination |
| **Autism/IDD** | Separate vs. Integration | Very Low | Telehealth diagnosis, workforce pipeline, lifespan continuity, transition planning |

### Adequacy Patterns

**Moderate adequacy** characterizes populations where universal approaches provide substantial benefit with specific enhancements needed. Rural elderly, post-industrial communities, Appalachian populations, veterans, and rural children fall into this category. These populations can be served through strengthened general rural health systems with targeted investments in population-specific needs like geriatric workforce, military trauma competency, or pediatric access.
...
Series 9 analysis supports six conclusions with varying confidence levels.
...
Series 9 analysis leaves several questions unresolved.

### Question 1: How Much Accommodation Complexity Is Manageable?

Universal approaches that ignore population differences fail distinct populations. Population-specific accommodations that multiply program complexity create administrative burden, coordination failures, and eligibility confusion. The same person belonging to multiple categories may not know which population-specific program applies or how to navigate between them.
...
People facing intersectional disadvantage need integrated responses, not categorical programs. But program administration, funding streams, and accountability structures are organized categorically. Building person-centered programs within categorical funding structures is possible but difficult.
...
Series 9 surfaced competing perspectives on population-specific transformation. Synthesis requires assessing which perspectives evidence supports.

### The Population Fragmentation Critique

**The perspective:** Organizing healthcare around population categories fragments systems and creates administrative complexity. Everyone belongs to multiple populations. Population-specific programs create eligibility confusion, service gaps between categories, and coordination failures. The same person may be an elderly veteran with substance use disorder in a persistent poverty Appalachian community. Which population-specific program applies? Categorical approaches serve administrative requirements rather than whole people.
...
### What Universal Transformation Can Provide

**Universal frameworks** can establish common elements across populations:
...
**Advocate for population-specific accommodation.** Universal approaches will not serve distinct populations without explicit advocacy. Tribal nations, farmworker organizations, veteran service organizations, and disability advocacy groups must ensure state transformation planning incorporates population needs.
...
**Allow state flexibility for population accommodation.** Universal requirements cannot serve distinct populations without flexibility. Enable states to design tribal engagement, farmworker outreach, and reentry coordination appropriate to their populations and circumstances.
...
## Part VIII: Transition to Series 10

Series 9 examined populations with distinct circumstances that challenge universal transformation approaches. The analysis revealed how demographic, geographic, and condition characteristics shape whether and how populations benefit from transformation. The consistent finding across sixteen populations is that **universal frameworks provide necessary foundations but population-specific accommodations are essential for distinct circumstances**.

Series 10 shifts focus from populations to places. **Regional deep dives** examine geography where circumstances crossing state boundaries create challenges that state-level analysis and implementation cannot fully address.

The Mississippi Delta spans Arkansas, Louisiana, and Mississippi. Transformation occurring in each state separately cannot address the regional healthcare labor market that draws providers to urban centers across all three states. The Texas-Mexico border creates healthcare dynamics that neither Texas RHTP nor federal immigration policy alone can address. Appalachian Kentucky shares more healthcare infrastructure characteristics with West Virginia than with Louisville. Alaska's vast distances and extreme weather create circumstances that Lower 48 frameworks cannot accommodate.
...
Series 9 asked whether universal transformation serves diverse populations. The answer was qualified: universal frameworks help, but distinct populations require distinct accommodations. Series 10 asks whether state-administered transformation can address regional challenges. The Delta, Appalachia, the border, and the frontier create healthcare realities that state boundaries do not capture. Understanding these regional dynamics completes the foundation for assessing what transformation can achieve.

## Appendix: Series 9 Summary

| Article | Population | Core Tension | Evidence Assessment |
|---------|------------|--------------|---------------------|
| **9A** | Rural Elderly | Current vs. Infrastructure | Moderate evidence for interventions; infrastructure collapse continues |
| **9B** | Tribal/Indigenous | Separate vs. Integration | Strong evidence for self-determination; coordination challenges persist |
| **9C** | Frontier | Universal vs. Extreme | Limited evidence for alternatives; geography fundamentally constrains |
| **9D** | Farmworkers | Visibility vs. Need | Strong evidence of need; weak evidence of inclusion |
| **9E** | Persistent Poverty | Current vs. Intergenerational | Strong evidence structural barriers dominate; healthcare necessary but insufficient |
| **9F** | Post-Industrial | Resilience vs. Barriers | Moderate evidence; economic context shapes health outcomes |
| **9G** | Black Belt/Delta | Characteristics vs. Discrimination | Strong evidence of discrimination effects; equity investment lacking |
| **9H** | Appalachian | Resilience vs. Barriers | Moderate evidence; community assets underutilized |
| **9I** | Border | Universal vs. Binational | Limited evidence; binational reality systematically ignored |
| **9J** | Veterans | Separate vs. Integration | Strong VA evidence; coordination with mainstream limited |
| **9K** | Rural Children | Current vs. Future | Moderate evidence; pediatric access gaps persist |
| **9L** | Justice-Involved | Visibility vs. Need | Strong evidence of transition mortality; political support absent |
| **9M** | SUD | Characteristics vs. System | Strong evidence for MAT; access gaps severe |
| **9N** | SMI | Separate vs. Integration | Strong evidence for intensive services; workforce absent |
| **9O** | Complex Conditions | Universal vs. Specialty | Moderate evidence for hub-and-spoke; implementation difficult |
| **9P** | Autism/IDD | Separate vs. Integration | Moderate evidence for early intervention; workforce fundamentally absent |

## Sources

Series 9 articles drew from sources including:

Bureau of Justice Statistics. "Prisoners in 2022: Statistical Tables." U.S. Department of Justice, Nov. 2023.

Centers for Disease Control and Prevention. "Data and Statistics on Autism Spectrum Disorder." CDC, 2024.

Department of Veterans Affairs. "Office of Rural Health Annual Report." VA, 2024.

Government Accountability Office. "Indian Health Service: Spending Levels and Characteristics." GAO-19-74R. GAO, 2018.

Health Resources and Services Administration. "National Health Service Corps Program Data." HRSA, 2024.

Indian Health Service. "IHS Profile." Department of Health and Human Services, 2024.

Kaiser Family Foundation. "Medicaid Home and Community-Based Services Waiting Lists." KFF, 2024.

National Agricultural Workers Survey. "Findings from NAWS 2019-2020." U.S. Department of Labor, 2024.

National Indian Health Board. "Tribal Budget Formulation Workgroup Recommendations." NIHB, 2025.

Rural Health Information Hub. Population-specific topic overviews. RHIhub, 2024.

U.S. Census Bureau. "American Community Survey 5-Year Estimates." Census Bureau, 2023.

USDA Economic Research Service. "County Typology Codes: 2025 Edition." USDA ERS, 2025.

Series 9 population articles from this project.
