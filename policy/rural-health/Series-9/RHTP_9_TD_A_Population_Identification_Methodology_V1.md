# RHTP 9.TD.A: Population Identification Methodology
...
**Series 9 Population Articles:** Each article applies these identification methods to specific populations. TD-A provides the methodological foundation; population articles address population-specific nuances.

**Technical Document 9-TD-B:** Exemption and Accommodation Frameworks examines when populations require specific RHTP adaptations, building on the population characteristics documented here.

**Technical Document 9-TD-C:** Cross-Population Intersectionality Analysis develops the intersection framework introduced here into operational guidance for addressing compound disadvantage.

**Technical Document 1-TD-C:** Regional Variation Matrix provides the geographic framework within which population identification occurs.

**Technical Document 3-TD-E:** State Inventory documents state-level infrastructure for serving identified populations.

## Sources

Appalachian Regional Commission. "Data Reports: County Economic Status and Distressed Areas." ARC, 2024, arc.gov/data-reports.

Bureau of Justice Statistics. "Correctional Populations in the United States." DOJ, 2024, bjs.ojp.gov/library/publications.

Centers for Disease Control and Prevention. "Autism and Developmental Disabilities Monitoring Network." CDC, 2024, cdc.gov/autism/addm.

Centers for Disease Control and Prevention. "BRFSS Prevalence & Trends Data." CDC, 2024, cdc.gov/brfss/brfssprevalence.

Centers for Medicare & Medicaid Services. "Geographic Variation Public Use File." CMS, 2024, cms.gov/research-statistics-data-systems/statistics-trends-and-reports/medicare-geographic-variation.

Health Resources and Services Administration. "Area Health Resources Files." HRSA, 2024, data.hrsa.gov/topics/health-workforce/ahrf.

Indian Health Service. "IHS Profile." IHS, 2024, ihs.gov/aboutihs/thisisihs.

National Center for Farmworker Health. "Farmworker Health Factsheet." NCFH, 2024, ncfh.org/resources.

Substance Abuse and Mental Health Services Administration. "National Survey on Drug Use and Health." SAMHSA, 2024, samhsa.gov/data/data-we-collect/nsduh.

U.S. Census Bureau. "American Community Survey Data." Census Bureau, 2024, census.gov/programs-surveys/acs/data.html.

U.S. Census Bureau. "Post-Enumeration Survey: 2020 Census Coverage Estimates." Census Bureau, 2022, census.gov/newsroom/press-releases/2022/2020-census-estimates-of-undercount-and-overcount.html.

U.S. Department of Agriculture Economic Research Service. "Rural-Urban Continuum Codes." USDA ERS, 2023, ers.usda.gov/data-products/rural-urban-continuum-codes.
...
U.S. Department of Veterans Affairs. "VA Enrollee Health Care Utilization." VA, 2024, va.gov/health/utilization.asp.

*RHTP 9.TD.A: Population Identification Methodology / Series 9: Special Populations / Rural Health Transformation Project / Version 1: February 2026*
