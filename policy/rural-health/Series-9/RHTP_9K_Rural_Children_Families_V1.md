...
The approximately **9 million rural children** are distributed unevenly. States with large rural populations contain substantial numbers: Texas with over 800,000, Ohio with approximately 600,000, Pennsylvania with 500,000. Geographic concentration matters for service planning. Some rural regions have sufficient child populations to support pediatric services if providers existed. Others have populations so sparse that **no business case exists for dedicated pediatric infrastructure** regardless of need.

### Demographic Characteristics

Rural children are more likely than urban children to be **non-Hispanic white**, though this varies by region. Rural areas in the South and Southwest have substantial Black, Hispanic, and Indigenous child populations. **Household characteristics** distinguish rural from urban children: more likely to live in married-couple families, but also more likely to live in poverty, with parents lacking college education and working in physically demanding occupations.
...
### Outcomes Compared to Urban Children

Rural children experience **worse health outcomes across multiple measures**. **Infant mortality rates** run higher in rural areas, with the rural-urban gap widening. Rural infant mortality exceeds 6 per 1,000 live births while urban rates have declined below 5.
...
**Pediatric specialist absence** represents the most significant barrier. Developmental pediatricians diagnosing autism and developmental delays are essentially nonexistent in rural areas. Child psychiatrists are urban phenomena. Pediatric subspecialists practice exclusively in metropolitan areas and regional children's hospitals.
...
Rural children are **less likely to receive well-child visits** at recommended intervals and more likely to rely on emergency departments for acute care. They are less likely to receive recommended vaccinations on schedule.
...
| Measure | Rural Children | Urban Children | Gap | Data Source |
|---------|---------------|----------------|-----|-------------|
| Pediatricians per 10,000 children | 3.2 | 8.7 | -63% | HRSA Area Health Resource File 2023 |
| Children with unmet healthcare needs | 4.8% | 3.2% | +50% | National Survey of Children's Health 2022 |
| Childhood obesity prevalence | 19.8% | 15.3% | +29% | CDC National Health and Nutrition Survey 2022 |
| Dental visit in past year | 71.2% | 78.4% | -9% | National Survey of Children's Health 2022 |
| Children with 1+ ACE | 53% | 47% | +13% | National Survey of Children's Health 2022 |
...
| Infant mortality per 1,000 births | 6.4 | 5.1 | +25% | CDC Wonder 2022 |
| Special education services received | 14.2% | 12.8% | +11% | NCES 2022 |
| Medicaid/CHIP coverage | 47% | 39% | +21% | ACS 2023 |
...
The tension between current adult needs and childhood investment reflects a genuine resource constraint that no policy can wish away. Rural communities lack sufficient resources to fully address both adult chronic disease burden and childhood developmental needs. Federal programs like RHTP set timelines that structurally favor measurable short-term outcomes over long-term investment returns.
...
### Vignette: The Developmental Window

Maria noticed something different about her son Jaylen around 18 months. He did not point at things. He did not respond to his name consistently. His language was not developing like his older sister's had. The pediatrician in their rural Arkansas town listened to Maria's concerns at the two-year well-child visit, agreed that developmental evaluation was warranted, and referred the family to the developmental pediatrician in Little Rock.
...
RHTP state applications include variable attention to pediatric populations. Some states have prioritized maternal and child health explicitly, while others have treated children as incidental beneficiaries of general transformation.

| State | Children-Specific Provisions | Funding Level | Implementation Approach |
|-------|------------------------------|---------------|------------------------|
| Tennessee | Maternal/child health goal, facility upgrades, perinatal expansion, mobile pregnancy app | $30-40M | Dedicated MCH stream with facility investments |
| Ohio | School-based health center expansion, OH SEE vision/dental program | $20-30M | School partnership approach |
| North Carolina | Early childhood system integration, home visiting expansion | $15-25M | MCH network strengthening |
| Georgia | Pediatric telehealth hub, developmental screening expansion | $10-20M | Regional pediatric telehealth access |
| Kentucky | School-based services, adolescent behavioral health | $10-15M | School-focused adolescent services |
| Texas | Limited pediatric provisions in state applications | Minimal explicit | General access improvements assumed to reach children |
...
**What RHTP provides:** Opportunity for states prioritizing children to fund pediatric-specific initiatives. Flexibility in state application design allows maternal and child health emphasis. Some states have used this flexibility effectively.
...
**Pediatric telehealth expansion** enabling rural children to access pediatric specialists without traveling to children's hospitals. Technology exists. The question is whether RHTP funding establishes sustainable telehealth infrastructure or temporary access that disappears when funding ends.
...
- 1.B: Demographics (child population characteristics)
- 1.C: Education and Literacy (school system context)
- 1.D: Economics and Employment (family economic context)

**Series 4: Transformation Approaches**
- 4.C: Telehealth and Virtual Care (pediatric telehealth applications)
- 4.L: Maternal and Child Health (MCH systems)

**Series 7: Healthcare Providers**
- 7.C: Federally Qualified Health Centers (SBHC sponsorship)
- 7.G: Behavioral Health Providers (pediatric mental health)

**Series 8: Community Organizations**
- 8.J: Schools and Youth Organizations (school-based services)

**Series 9: Special Populations**
- 9.A: Rural Elderly (life stage parallel)
- 9.E: Persistent Poverty Communities (poverty context)
- 9.H: Appalachian Communities (regional child health)

## Sources

American Academy of Pediatrics. "Telehealth Parity Project: Implementation Toolkit for Pediatric Telehealth." American Academy of Pediatrics, 2023.

Association of American Medical Colleges. "2023 State Physician Workforce Data Report." AAMC, 2023.

Boyce, Faith, and Marcus Crittenden. "Why It's So Hard to Attract New Doctors to Pediatrics." STAT News, 27 November 2024.

Centers for Disease Control and Prevention. "About Adverse Childhood Experiences." CDC, 30 September 2025.

Centers for Medicare and Medicaid Services. "Medicaid and CHIP Overview September 2024." CMS, 2024.

Children's Hospital Association. "Pediatric Workforce Shortages Persist in 2024." Children's Hospital Association, 28 January 2025.

DiNapoli, Thomas P. "Rural Counties Face Shortage of Health Professionals." Office of the New York State Comptroller, August 2025.

Georgetown University Center for Children and Families. "Medicaid's Role in Small Towns and Rural Areas." Georgetown University, January 2025.

Health Affairs. "Twenty Years Of School-Based Health Care Growth And Expansion." Health Affairs Journal, 2019.

Health Resources and Services Administration. "Exploring the Rural Context of Adverse Childhood Experiences." HRSA, August 2018.

Kjolhede, Christopher, et al. "School-Based Health Centers and School Attendance in Rural Areas." JAMA Network Open, 2025.

Kozhimannil, Katy Backes, et al. "Rural-Urban Differences in Adverse Childhood Experiences Across a National Sample of Children." Journal of Rural Health, vol. 35, no. 3, 2019.

MACPAC. "MACStats: Medicaid and CHIP Data Book December 2024." Medicaid and CHIP Payment and Access Commission, December 2024.

National Survey of Children's Health. "2022 National Survey of Children's Health." Health Resources and Services Administration, 2022.

School-Based Health Alliance. "National School-Based Health Care Census." School-Based Health Alliance, 2017.

The Community Guide. "SDOH: School-Based Health Centers." The Community Preventive Services Task Force, 2024.

Zhang, Xi, et al. "School-Based Health Centers as an Approach to Address Health Disparities among Rural Youth." PLoS ONE, vol. 19, no. 5, 2024.

*Series 9: Special Populations*
*Rural Health Transformation Project*
*Article 9K: Rural Children and Families*
