...
## Building Clinics for Patients Who Lost Insurance
...
**2B Medicaid Architecture:** Establishes coverage baseline and Section 1115 waiver context for understanding how work requirements alter eligibility.

**7C Federally Qualified Health Centers:** Examines facilities most dependent on Medicaid revenue and most exposed to coverage contraction.

**9E Persistent Poverty Communities:** Analyzes populations concentrated in areas where coverage loss, procedural disenrollment, and work requirement barriers converge.

**3 State Profiles (all):** Provides state-specific context for Medicaid expansion status, unwinding outcomes, and work requirement implementation.
