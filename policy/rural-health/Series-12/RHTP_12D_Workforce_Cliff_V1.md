# RHTP 12.D
# The Workforce Cliff
## Pipeline Investment vs. Structural Exodus
...
**4B Workforce:** Examines transformation approaches to workforce development, including evidence base for various interventions and state strategy patterns.

**7D Independent Physician Practices:** Provides practice condition context for understanding why providers leave independent practice, with implications for rural retention efforts.

**7G Behavioral Health Providers:** Analyzes specialty shortage context for behavioral health workforce, including reimbursement and practice pattern barriers specific to mental health services.

**14C Community Health Workers:** Assesses workforce innovation potential for CHW programs, including evidence, implementation requirements, and sustainability questions.
