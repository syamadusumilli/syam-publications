...
- 14A The Inverse Hub (virtual-first delivery model assumed operational)
- 14B AI as Infrastructure (companion deployment projections)
- 14C The Local Workforce (CHW employment projections)
- 14D The Service Center (facility configuration assumed implemented)
- 14E State Sovereign Investment (fund capitalization projections)
- 14F Governance Models (community governance assumed functional)
- 14G Tribal Demonstration (demonstration timeline foundation)

**Series 15: Enabling Conditions**
- 15A Regulatory Transformation (scope and licensing changes assumed achieved)
- 15B The Nomadic Professional Model (workforce infrastructure assumed built)
- 15C Technology Governance (AI accountability frameworks assumed established)
- 15D Interstate Infrastructure (compact expansion assumed achieved)
- 15E Political Economy (coalition formation assumed successful)

**Series 10: Regional Deep Dives**
- 10A Appalachian Mountains (early adopter regional context)
- 10K Upper Midwest (fast follower regional context)
- 10R Tribal Lands (demonstration foundation)

**Series 16: Futures and Action**
- 16A Integration (cumulative case this scenario assumes implemented)
- 16C Partial Transformation Scenario (comparison: mixed outcomes)
- 16D Managed Decline Scenario (comparison: current trajectory)
...
National Academies of Sciences, Engineering, and Medicine. "The Future of Nursing 2020-2030: Charting a Path to Achieve Health Equity." National Academies Press, 2021, doi.org/10.17226/25982.
...
Indian Health Service. "Community Health Aide Program Expansion: Annual Report." IHS, 2025, www.ihs.gov/chap.
