...
- 14A The Inverse Hub (virtual-first delivery model)
- 14B AI as Infrastructure (companions, legal/financial services, coordination)
- 14C The Local Workforce (sustainable community careers)
- 14D The Service Center (right-sized physical presence)
- 14E State Sovereign Investment (patient capital)
- 14F Governance Models (commons, cooperatives, innovation zones)
- 14G Tribal Demonstration (sovereignty as regulatory laboratory)

**Series 15: Enabling Conditions**
- 15A Regulatory Transformation (scope, licensing, technology, payment)
- 15B The Nomadic Professional Model (workforce infrastructure)
- 15C Technology Governance (AI and robot accountability)
- 15D Interstate Infrastructure (regional coordination)
- 15E Political Economy (coalition building and opposition)

**Series 12: Policy Earthquake**
- 12E The Convergence (cascading failure dynamics)

**Series 1-2: Foundations**
- Series 1 articles (terrain of rural America)
- Series 2 articles (federal policy architecture)

**Series 16: Futures and Action**
- 16B The Transformation Scenario (what success looks like)
- 16C Partial Transformation Scenario (mixed outcomes)
- 16D Managed Decline Scenario (current trajectory continued)
