...
| Source | Data Type |
|--------|-----------|
| **USDA Economic Research Service (ERS)** | Rural classifications, population, economic indicators |
| **U.S. Census Bureau (ACS)** | Demographics, income, education, housing |
| **Federal Communications Commission (FCC)** | Broadband access, connectivity |
| **Centers for Medicare and Medicaid Services (CMS)** | Healthcare utilization, provider data |
| **UNC Sheps Center for Health Services Research** | Hospital closures, rural health infrastructure |
| Feeding America (Map the Meal Gap) | Food insecurity, meal costs |
| KFF (Kaiser Family Foundation) | Insurance coverage, Medicaid data |
| Chartis Rural Health Analysis | Hospital financial viability |
| National Center for Education Statistics | Education attainment, enrollment |
...
|----------|-------|----------|
| **1-TD-A** | Statistical Data Companion | *This document* |
| **1-TD-B** | Rural Classification Reference Guide | Classification systems, concordance tables, program eligibility crosswalks |
| **1-TD-C** | Regional Variation Matrix | Seven-region demographic, economic, and health infrastructure comparison |
