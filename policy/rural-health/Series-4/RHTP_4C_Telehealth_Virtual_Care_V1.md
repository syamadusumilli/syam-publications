# RHTP 4.C: Telehealth and Virtual Care

## When Does Technology Extend Care Versus Substitute for It?
...
**Medicare telehealth flexibilities enacted during COVID-19 have been repeatedly extended but remain time-limited.** As of January 2026, most non-behavioral Medicare telehealth services operate under flexibilities expiring January 30, 2026, with Congress repeatedly extending deadline by deadline. This uncertainty complicates RHTP planning: states cannot confidently build telehealth infrastructure dependent on reimbursement policies that may expire.
...
**RHCs and FQHCs face particular reimbursement challenges.** Medicare's "special payment rule" reimburses these safety-net providers at approximately $97.53 for any of over 280 telehealth services, a composite rate often lower than what they earn for in-person services. This rate structure creates financial disincentives for telehealth adoption among the providers most essential to rural healthcare access.
...
**Congress has not established permanent Medicare telehealth policy.** The repeated short-term extensions (six months, then eighteen months, then another extension) prevent long-term planning while creating ongoing uncertainty. States investing RHTP funds in telehealth infrastructure cannot know whether Medicare will continue reimbursing these services at current rates, reduced rates, or at all.

Behavioral health telehealth has permanent authorization, providing a stable foundation for telebehavioral health investments. Other modalities lack this permanence. **The distinction matters for RHTP planning: investments in telebehavioral health face less policy risk than investments in other telehealth applications.**
...
RHTP applications treating telehealth as comprehensive solution misunderstand the evidence. Applications integrating telehealth with workforce development, facility investment, and care coordination align better with what research demonstrates. **The 2030 question is whether RHTP builds sustainable hybrid systems or temporary virtual overlays on collapsing physical infrastructure.**
...
**Reimbursement trajectory.** What happens to telehealth revenue if Medicare flexibilities expire? What are state Medicaid payment policies? How do private payers reimburse telehealth services?
...
**4G (Behavioral Health Integration):** Telebehavioral health represents the intersection of Series 4's two strongest evidence-based transformation approaches.

**4J (Digital Infrastructure):** Broadband prerequisites for telehealth; infrastructure investment coordination.

**4K (Emergency and Trauma Systems):** Telestroke and tele-trauma networks; emergency department telehealth consultations.

**4B (Workforce):** Telehealth extends workforce reach but does not eliminate workforce requirements; provider training needs.

### From Series 2

**2A (RHTP Structure):** Technology requirements in RHTP NOFO; allowable telehealth investments.

**2C (Medicare Rural Provisions):** Medicare telehealth reimbursement policy; flexibility expiration timeline.

### From Series 3

**3.NM (New Mexico):** Project ECHO model origin and implementation.

**3.MS (Mississippi):** UMMC telehealth network as RHTP foundation.

**3.AK (Alaska):** AFHCAN store-and-forward model for frontier conditions.
