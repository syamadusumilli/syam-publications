...
Primary Care Associations have served Federally Qualified Health Centers since the 1970s. Every state and several regions have HRSA-funded PCAs providing training, technical assistance, and advocacy. This sustained presence has built relationships that newer intermediaries cannot match.
...
Against this legitimacy advantage, PCA capacity constraints loom large. The 54 state and regional PCAs vary enormously in organizational sophistication.
...
The following table illustrates capacity variation across PCAs receiving RHTP-related funding:

| Organization | State | FQHC Members | Staff FTE | Annual Budget | RHTP Role | Subaward | Capacity Level |
|--------------|-------|--------------|-----------|---------------|-----------|----------|----------------|
| California Primary Care Assn | CA | 219 | 65 | $18.2M | Workforce, quality, rural expansion | $16M | High |
| Texas Assn of Community Health Centers | TX | 76 | 38 | $9.4M | Rural TA, care model development | $12M | High |
| Pennsylvania Assn of Community Health Centers | PA | 44 | 28 | $6.8M | Quality improvement, workforce | $8M | Moderate-High |
| Georgia Primary Care Assn | GA | 34 | 22 | $4.9M | Rural access, integration | $7M | Moderate |
| North Carolina Community Health Center Assn | NC | 43 | 19 | $4.2M | Network coordination, TA | $6M | Moderate |
| Ohio Assn of Community Health Centers | OH | 52 | 24 | $5.1M | Quality, rural expansion | $5M | Moderate |
| Kentucky Primary Care Assn | KY | 28 | 12 | $2.8M | Rural TA, workforce | $4M | Moderate-Low |
| Montana Primary Care Assn | MT | 18 | 8 | $1.9M | Rural coordination, TA | $3M | Low |
| Nevada Primary Care Assn | NV | 12 | 6 | $1.4M | Basic TA, coordination | $2M | Low |
...
The Appalachian Community Health Initiative (name changed) illustrates how PCA legitimacy can mask capacity limitations with consequences for transformation implementation.
...
Critics of capacity-based PCA assessment must contend with the alternative: bypassing PCAs in favor of contractors or consultants without safety-net relationships. This approach trades legitimacy for capacity, potentially losing more than it gains.
...
State approaches to PCA RHTP subawards reflect different assumptions about the capacity-legitimacy balance.

| State | Subawardee | Award Amount | Functions | Pass-Through % | Capacity Assessment |
|-------|------------|--------------|-----------|----------------|---------------------|
| California | CPCA | $16.4M | Workforce, quality, rural expansion | 45% | Formal capacity review |
| Texas | TACHC | $12.1M | Rural TA, care models | 38% | Prior performance eval |
| Pennsylvania | PACHC | $8.3M | Quality improvement, workforce | 41% | Informal assessment |
| Georgia | GPCA | $7.2M | Rural access, integration | 35% | Limited assessment |
| North Carolina | NCCHCA | $6.1M | Network coordination, TA | 33% | None documented |
| West Virginia | WVPCA | $5.8M | Transformation support | 29% | None documented |
| Kentucky | KPCA | $4.2M | Rural TA, workforce | 36% | None documented |
| Montana | MTPCA | $3.1M | Rural coordination | 31% | None documented |
...
PCAs operate under HRSA cooperative agreements that create accountability relationships distinct from state RHTP oversight. This dual accountability complicates transformation implementation.
...
Despite capacity limitations, PCAs contribute genuine transformation value under specific conditions.
...
The same legitimacy that enables PCA value-add can obstruct transformation when capacity proves insufficient.
...
Colorado's approach to PCA RHTP involvement illustrates how capacity assessment can improve implementation.
...
The Colorado approach requires states to invest in capacity assessment and relationship management with multiple intermediaries. Not all states have the agency capacity for this more complex implementation design. But for states that can manage complexity, capacity matching produces better transformation outcomes than legitimacy-based scope assignment.

## Assessment and Recommendations

PCAs occupy an intermediary position where legitimacy and capacity intersect imperfectly. **Neither can be ignored**; both must be assessed.
...
- **Series 5** (State Agencies): 5A examines lead agency decisions about intermediary selection; 5C covers procurement approaches including PCA subawards
- **Series 7** (Healthcare Providers): 7C assesses FQHC perspectives on PCA value; provider views test whether state-perceived legitimacy translates to experienced support quality
- **Series 3** (State Profiles): California, Texas, Colorado, and West Virginia profiles detail state-specific PCA arrangements and capacity considerations
- **Series 4** (Transformation Approaches): 4D examines community health worker programs where PCAs often serve as training intermediaries; 4G covers behavioral health integration where PCA capacity varies dramatically

## Sources

Arizona Alliance for Community Health Centers. "About AACHC." AACHC, 2025, aachc.org/about.

Bureau of Primary Health Care. "FY 2025 PCA NCC Progress Report: Sample Staffing Plan." HRSA, 2025, bphc.hrsa.gov/funding/funding-opportunities/pca/staff-planning.

Bureau of Primary Health Care. "FY25 PCA NCC Frequently Asked Questions." HRSA, 2025, bphc.hrsa.gov/funding/funding-opportunities/pca/faq.

Bureau of Primary Health Care. "What's a Primary Care Association (PCA)?" HRSA, 2025, bphc.hrsa.gov/technical-assistance/strategic-partnerships/primary-care-associations.

California Primary Care Association. "About CPCA." CPCA, 2025, cpca.org/about.

Georgia Primary Care Association. "About GPCA." GPCA, 2025, georgiapca.org/about.

National Association of Community Health Centers. "Annual Report 2023." NACHC, 2024, nachc.org/about-nachc/mission/nachc-annual-report-2023.

National Association of Community Health Centers. "Directory of PCAs and HCCNs." NACHC, 2025, nachc.org/state-regional-affiliates-networks/directory-of-pcas-hccns.

National Association of Community Health Centers. "Federal Grant Funding." NACHC, 2025, nachc.org/policy-advocacy/health-center-funding/federal-grant-funding.

National Association of Community Health Centers. "Health Center Funding Policy Paper." NACHC, Dec. 2024, nachc.org/wp-content/uploads/2024/11/NACHCHealthCenterFundingPolicyPaper_Dec2024_Final.pdf.

North Carolina Community Health Center Association. "Our Programs." NCCHCA, 2025, ncchca.org/about-us/our-programs.

Pennsylvania Association of Community Health Centers. "About PACHC." PACHC, 2025, pachc.org/about.

---

*RHTP Series 6: Intermediary Organizations*
*Rural Health Transformation Project*
*Article 6.B Version 2*
*January 2026*
