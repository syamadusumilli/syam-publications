...
1. Engage communities as partners, not problems
2. Build on existing institutions rather than creating parallel structures  
3. Hire from within communities, not parachuting outsiders
4. Acknowledge community strengths in program design
5. Address structural barriers that communities cannot address alone
6. Measure success by community-defined outcomes, not just external metrics
...
1. Coordinate workforce recruitment across state lines
2. Develop shared telehealth infrastructure
3. Align community health worker training and certification
4. Share data on regional health patterns
5. Present a unified regional voice in federal policy
...
1. **Regional recognition within state plans.** CMS could require states to identify sub-state regions and tailor strategies accordingly. Texas, Louisiana, and Mississippi could acknowledge the Piney Woods as a region requiring specific attention.

2. **Interstate coordination incentives.** CMS could provide bonus funding for states that coordinate across shared regions. The three Piney Woods states could develop joint workforce, telehealth, and CHW initiatives.

3. **Identity-respecting metrics.** Performance measurement could include community-defined outcomes alongside standard metrics. Success could be measured by what communities value, not just what funders count.

4. **Asset-based implementation.** Guidance could require that state plans build on existing community institutions rather than creating parallel structures.

### What RHTP Cannot Provide

1. **Regional commission or authority.** Creating new governance structures is beyond program scope.

2. **Forced interstate coordination.** Coordination must be voluntary; CMS cannot require it.

3. **Economic development.** Healthcare investment alone cannot replace timber and oil economies that no longer sustain communities.

4. **Visibility parity with Delta or Appalachia.** The Piney Woods lack the policy infrastructure and advocacy organizations that those regions have built over decades.

## Cross-References

**Series 3 State Profiles:**
- RHTP_3TX: Texas RHTP analysis
- RHTP_3LA: Louisiana RHTP analysis  
- RHTP_3MS: Mississippi RHTP analysis

**Series 9 Population Articles:**
- RHTP_9E: Persistent Poverty Communities (applicable to Piney Woods counties)

**Series 10 Regional Articles:**
- RHTP_10D: Mississippi Delta (comparison of recognized vs. unrecognized regions)
- RHTP_10F: Great Plains (different regional challenge)
- RHTP_10H: Upland South (shared identity tensions)

**Series 4 Transformation Approaches:**
- RHTP_4D: Community Health Workers (applicable to church-based model)
- RHTP_4C: Telehealth (infrastructure needs)

## Sources

Ashford, Molly. "Already in the Red, Rural Hospitals Across the Midwest Brace for Medicaid Changes." Nebraska Public Media, 24 July 2025.

Center for Healthcare Quality and Payment Reform. "Rural Hospital Closures and Vulnerability Analysis." October 2024.
...
Decker, Stephanie. "Health Differences Between Rural and Non-Rural Texas Counties Based on 2023 County Health Rankings." BMC Health Services Research, vol. 24, 2024.

Federal Office of Rural Health Policy. "Rural Hospital Closures Database." HRSA, updated January 2025.

Louisiana Department of Health. "2023 Louisiana Health Report Card." 2024.

Maxwell, Thad. "The Piney Woods of East Texas: A Regional History." East Texas Historical Journal, vol. 58, no. 2, 2020, pp. 45-72.

Office of the Assistant Secretary for Planning and Evaluation. "Access to Health Care in Rural America: Current Trends and Key Challenges." ASPE Research Report, October 2024.

Rural Health Information Hub. "Louisiana Resources." Accessed January 2026.

Rural Health Information Hub. "Rural Health Disparities Overview." Updated December 2024.

Texas Organization of Rural & Community Hospitals. "Rural Health in Texas: 2024 Status Report." TORCH, 2024.
...
Walker, Juliet. "Invisible Regions: Federal Policy and the Piney Woods South." Southern Studies, vol. 31, no. 1, 2022, pp. 88-114.
