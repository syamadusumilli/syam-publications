...
| State | Appalachian Counties | Appalachian Population | Distressed Counties | RHTP Award (Est.) |
|-------|---------------------|------------------------|---------------------|-------------------|
| Kentucky | 54 | 1,180,000 | 38 | $213M |
| West Virginia | 55 (entire state) | 1,793,000 | 12 | $198M |
| Tennessee | 52 | 2,987,000 | 6 | $205M |
| Virginia | 25 | 398,000 | 5 | $165M |
| Ohio | 32 | 2,088,000 | 8 | $192M |
| North Carolina | 29 | 1,731,000 | 2 | $175M |
| Pennsylvania | 52 | 3,053,000 | 0 | $186M |
| Georgia | 37 | 1,124,000 | 2 | $211M |
| Alabama | 37 | 2,967,000 | 2 | $200M |
| New York | 14 | 958,000 | 0 | $168M |
| Other ARC States | 36 | 8,051,000 | 6 | Variable |
...
### Health Outcomes: The Worst Corridors in Eastern America

Central Appalachian health outcomes represent **the floor for American rural health**. The statistics describe a population dying younger, sicker, and more desperately than almost anywhere else in the country.

| Measure | Central Appalachia | National Rural | National | Gap |
|---------|-------------------|----------------|----------|-----|
| Life Expectancy | 72.8 years | 76.1 years | 78.6 years | -5.8 years |
| Overdose Deaths (per 100K) | 48.2 | 25.6 | 22.0 | +26.2 |
| Heart Disease Mortality (per 100K) | 245 | 195 | 165 | +80 |
| Diabetes Prevalence | 14.8% | 11.2% | 9.4% | +5.4% |
| Adult Smoking Rate | 26.4% | 18.5% | 12.5% | +13.9% |
| Obesity Rate | 38.2% | 34.1% | 30.4% | +7.8% |
...
Hospital closures have **concentrated in Appalachia** over the past decade. The region's hospitals operate on margins that cannot sustain disruption. Medicare and Medicaid reimburse below cost. Commercial insurance patients, those with employer coverage who generate operating margin, increasingly travel to urban facilities for care. What remains are **facilities serving the sickest, poorest, oldest populations with payer mixes that guarantee financial loss**.

| State | Rural Hospitals at Risk | Recent Closures | Primary Care Shortage |
|-------|------------------------|-----------------|----------------------|
| Kentucky | 17 (25%) | Tyler Memorial (2021) | 254 HPSAs |
| West Virginia | 12 (35%) | Multiple CAH conversions | 58 HPSAs |
| Tennessee | 16 (44%) | Jellico (2022) | 86 HPSAs |
...
**RHTP's state-based structure cannot address Appalachian challenges that cross state lines.** The examples are concrete:
...
Across the 13 Appalachian states, RHTP investments totaling approximately **$2.4 billion** will reach Appalachian counties through state-administered programs. Key elements include:
...
**Regional workforce strategy.** Appalachia needs an Appalachian medical school pipeline, an Appalachian nursing consortium, an Appalachian community health worker certification that transfers across state lines. No state can create these alone. RHTP's state structure prevents collective action.
...
**Regional coordination mechanisms** that RHTP structure cannot provide. Interstate compacts for telehealth licensing, workforce reciprocity, and care coordination would enable efficient regional response. CMS could incentivize such compacts without creating new governance structures.
...
**Within the RHTP timeline, transformation can stabilize existing infrastructure**, expand telehealth where licensing permits within state boundaries, deploy community health workers from communities, and integrate behavioral health into primary care settings. These improvements matter.
...
**Transformation cannot create regional governance** that RHTP structure prevents. Thirteen separate state strategies will produce thirteen separate outcomes, with coordination occurring only where states voluntarily cooperate.
...
- RHTP 3.KY (Kentucky): Three-part analysis of Appalachian epicenter
- RHTP 3.WV (West Virginia): Entire state within ARC boundaries  
- RHTP 3.TN (Tennessee): East Tennessee Appalachian context
- RHTP 3.VA (Virginia): Southwest Virginia Appalachian counties
- RHTP 3.OH (Ohio): Southeast Ohio Appalachian region
- RHTP 3.PA (Pennsylvania): Western Pennsylvania Appalachian counties
- RHTP 3.NC (North Carolina): Western North Carolina mountains

**Series 9 Population Articles:**
- RHTP 9.H (Appalachian Communities): Detailed population analysis

**Series 4 Transformation Approaches:**
- RHTP 4.D (Community Health Workers): Relevant to regional workforce strategy
- RHTP 4.G (Behavioral Health Integration): Relevant to opioid crisis response

## Sources

Appalachian Regional Commission. "Appalachian Diseases of Despair: Update 2025." ARC, July 2025. arc.gov/wp-content/uploads/2025/07/Appalachian-Diseases-of-Despair-Update-2025.pdf.

Appalachian Regional Commission. "County Economic Status in Appalachia, FY 2024." ARC, 2024. arc.gov/map/county-economic-status-in-appalachia-fy-2024/.
...
Appalachian Regional Commission. "FY 2026 Congressional Justification." ARC, 2025. arc.gov/wp-content/uploads/2025/05/ARC-FY-2026-Congressional-Justification.pdf.

Center for Healthcare Quality and Payment Reform. "Rural Hospital Closures and Financial Distress." CHQPR, December 2025. chqpr.org/rural-hospital-closures/.

Centers for Disease Control and Prevention. "Drug Overdose Mortality by State." CDC WONDER, 2024. wonder.cdc.gov.

Commonwealth of Kentucky. "Kentucky Rural Health Transformation Program Application." Cabinet for Health and Family Services, 2025.

Feeding America. "Map the Meal Gap: Food Insecurity in Appalachia." Feeding America, 2024. feedingamerica.org.

Halverson, Joel A., Lian Ma, and E. James Harner. "An Analysis of Disparities in Health Status and Access to Health Care in the Appalachian Region." ARC, 2004.

Meit, Michael, et al. "Exploring Rural and Urban Mortality Differences." NORC Walsh Center for Rural Health Analysis, 2015.

Kentucky Office of Rural Health. "Kentucky Homeplace: Community Health Worker Program Outcomes." University of Kentucky Center of Excellence in Rural Health, 2025.

Quinones, Sam. "Dreamland: The True Tale of America's Opiate Epidemic." Bloomsbury, 2015.

State of West Virginia. "West Virginia Rural Health Transformation Program Application." Department of Health, 2025.

University of Wisconsin Population Health Institute. "County Health Rankings 2024." countyhealthrankings.org.

U.S. Census Bureau. "American Community Survey 5-Year Estimates, 2019-2023." census.gov.

Zhang, Z., et al. "An Analysis of Mental Health and Substance Abuse Disparities and Access to Treatment Services in the Appalachian Region." NORC and ETSU for ARC, 2008.

*Rural Health Transformation Project*
*Series 10: Regional Deep Dives*
*Article 10.A: The Appalachian Mountains*
