...
**Series 5 Articles**
- **5A (Lead Agency Structures):** Detailed analysis of lead agency patterns and authority gap theory
- **5B (Stakeholder Coordination):** How coordination partners interact with lead agencies
- **5C (Procurement and Contracting):** Procurement authority detailed by state
- **5D (Performance Measurement):** Measurement authority and accountability
- **5E (Federal-State Relationship):** CMS relationship dynamics in depth

**Series 3 State Profiles**
Individual state profiles provide detailed governance documentation for priority states.

**Technical Document 3-TD-D**
Program Subawardee Registry details implementation partners by state.
