---
title: "Rural Disease Burden Atlas"
date: 2026-07-29
author: "Syam Adusumilli"
summary: "Comprehensive Epidemiological Reference"
description: "RHTP Series 11: Rural Disease Burden Atlas"
tags: ["rural-health", "rhtp", "series-11", "technical-document", "sdoh", "telehealth"]
...
cover:
  image: "cover.webp"
  alt: "Rural Disease Burden Atlas"
  relative: true
  hidden: false
params:
  article_id: "RHTP-11-TD-A"
  article_type: "technical_document"
  series_number: 11
  series_title: "Clinical Reality"
  summary_url: "../rural-disease-burden-atlas-summary/"
...
- 4A Aging in Place: geriatric mortality patterns in Section 1
- 4C Telehealth: utilization trends in Section 4.3
- 4G Behavioral Health: mental health morbidity in Section 2.2
- 4L Maternal Child Health: MCH metrics in Section 2.3

**Series 7 (Healthcare Providers)**
- 7A Critical Access Hospitals: facility access in Section 3.2
- 7C FQHCs: primary care ratios in Section 3.1
- 7E EMS: response times in Section 3.2
- 7H Dental: oral health metrics in Section 2.4

**Series 9 (Special Populations)**
- 9A Rural Elderly: mortality patterns for 65+ throughout
- 9B Tribal Communities: Tribal Area column in all tables
- 9G Black Belt and Delta: Delta column in all tables
- 9H Appalachian Communities: Appalachia column in all tables

**Series 10 (Regional Deep Dives)**
- All regional articles reference this document for baseline mortality and morbidity data
- Regional variation serves as key analytical frame for transformation planning
...
Spencer, Merianne Rose, Matthew F. Garnett, and Arialdi M. Mini̱o. "Urban-Rural Differences in Drug Overdose Death Rates, 2020." Vital Statistics Rapid Release, no. 26. Hyattsville, MD: NCHS, 2022.

*Rural Health Transformation Project*
*Technical Document 11-TD-A*
