...
summary: "Binational Reality Meets Single-Nation Policy"
description: "RHTP Series 9: Border Communities"
...
params:
  ...
  summary_url: "../border-communities-summary/"
...
RHTP operates within a **U.S.-only framework** that assumes:
- Healthcare recipients are U.S. residents using U.S. facilities
- Providers are licensed in the U.S. and paid by U.S. payers
- Transformation success is measured by U.S. healthcare utilization
- International boundaries are barriers to cross, not lines that people regularly traverse
...
**Assessment**: This perspective correctly identifies the problem. Border health is inherently binational. U.S.-only approaches are inherently limited. However, binational health policy faces **enormous political and practical barriers**:

1. **Sovereignty concerns**: Healthcare policy is national policy. Coordinating across borders raises sovereignty questions that complicate implementation.

2. **Different systems**: Mexican healthcare operates through IMSS (social security), ISSSTE (government workers), Seguro Popular (now INSABI/IMSS-Bienestar), and private sector. Integration with a fragmented foreign system is technically difficult.

3. **Licensing and liability**: U.S. providers are not licensed to practice in Mexico. Mexican providers are not licensed in the U.S. Liability frameworks do not cross borders.

4. **Payment mechanisms**: U.S. payers (Medicare, Medicaid, private insurers) do not pay Mexican providers. Creating cross-border payment would require statutory changes that are not politically feasible.

5. **Immigration politics**: Any program that appears to facilitate healthcare for undocumented individuals faces political opposition that can undermine the entire effort.
...
**[VIGNETTE: El Paso and Ciudad JuÃ¡rez function as a single binational metropolitan area of 2.7 million people divided by an international border. Residents cross daily for work, shopping, and services. El Paso hospitals serve Mexican patients who can pay; JuÃ¡rez clinics serve El Paso residents seeking affordable care. A diabetic in El Paso may see a U.S. endocrinologist annually (insurance covers), purchase monthly insulin in JuÃ¡rez (one-tenth the cost), and check blood sugar using strips bought at a JuÃ¡rez pharmacy. When her daughter needed braces, they went to an ortodoncista in JuÃ¡rez for $1,500 rather than the El Paso orthodontist quoting $6,000. The family's healthcare is integrated across the border in ways that neither U.S. nor Mexican health systems recognize. RHTP measures only what happens on the U.S. side and sees gaps that do not exist. The family has continuous, adequate care; it just is not U.S. care.]**
...
1. **Recognition of binational healthcare reality** in program design, measurement, and evaluation. This does not require coordination with Mexican systems but acknowledgment that border residents use both systems.

2. **Documentation-sensitive design** that serves all residents through structures (FQHCs, community health workers) that do not require documentation verification.

3. **Services competitive with Mexican alternatives** recognizing that border residents compare U.S. services to accessible Mexican options. Building U.S. capacity that is more expensive, less accessible, and slower than Mexican alternatives will not change utilization patterns.

4. **Colonia infrastructure investment** addressing the environmental determinants that healthcare alone cannot address. This requires coordination with housing, water, and transportation agencies beyond health sector scope.

5. **Culturally and linguistically appropriate care** matching border community demographics. Spanish-language capacity is not optional accommodation but baseline requirement.
...
- RHTP 3.TX: Texas State Implementation
- RHTP 3.AZ: Arizona State Implementation
- RHTP 3.NM: New Mexico State Implementation
- RHTP 3.CA: California State Implementation
- [RHTP 4.D](/rural-health/series-4/rhtp-4d-community-health-workers/): Community Health Workers
- [RHTP 7.C](/rural-health/series-7/rhtp-7c/): Federally Qualified Health Centers
- [RHTP 8.I](/rural-health/series-8/rhtp-8i/): Immigrant and Farmworker Organizations
- [RHTP 9.B](/rural-health/series-9/rhtp-9b/): Tribal and Indigenous Communities (Tohono O'odham)
- [RHTP 9.D](/rural-health/series-9/rhtp-9d/): Agricultural and Seasonal Workers
- [RHTP 10.H](/rural-health/series-10/rhtp-10h-the-upland-south/): Texas-Mexico Border Regional Deep Dive
- [RHTP 10.L](/rural-health/series-10/rhtp-10l/): Colonias and Border Communities

## Sources

Bastida, Elena, et al. "Persistent Disparities in the Use of Health Care Along the US-Mexico Border." American Journal of Public Health, vol. 98, no. 11, 2008.

Centers for Disease Control and Prevention. "Border Health." CDC, 2025.

Health Resources and Services Administration. "Health Professional Shortage Areas." HRSA Data Warehouse, 2025.

Kaiser Family Foundation. "Health and Health Care in the U.S.-Mexico Border Region." KFF, 2025.

MHP Salud. "US Mexico Border Region." MHP Salud, 2024.

Mier, Nelda, et al. "Health-Related Quality of Life Among Mexican Americans Living in Colonias at the Texas-Mexico Border." Social Science and Medicine, vol. 66, no. 8, 2008.

Ortiz, Gabriela, et al. "Seeking Care Across the US-Mexico Border." Social Science and Medicine, vol. 347, 2024.

Su, Dejun, et al. "Cross-Border Utilization of Health Care." Journal of Immigrant and Minority Health, vol. 15, no. 4, 2013.

Texas Department of State Health Services. "Border Health." DSHS, 2025.

Texas Secretary of State. "Colonia Identification." SOS, 2025.

U.S.-Mexico Border Health Commission. "Healthy Border 2020." BHC, 2020.

Wallace, Steven P., et al. "Undocumented Immigrants and Health Care Reform." UCLA Center for Health Policy Research, 2024.

---

*RHTP 9.I: Border Communities*
