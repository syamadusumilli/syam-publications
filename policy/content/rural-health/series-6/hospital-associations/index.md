...
summary: "Member Advocates or Transformation Agents?"
description: "RHTP Series 6: Hospital Associations"
...
params:
  ...
  summary_url: "../hospital-associations-summary/"
...
RHTP invests $50 billion to transform rural health, not merely sustain existing arrangements. The program's logic assumes that current rural health infrastructure is inadequate and requires fundamental change. Some hospitals that exist today should not exist in their current form after transformation.
...
Hospital associations vary enormously in size, sophistication, and rural focus. Some associations maintain substantial rural programs with dedicated staff and significant resources. Others treat rural hospitals as a constituency among many, with limited specialized capacity.

| Association | State | Rural Members | Total Budget | Rural Staff | RHTP Role | Est. Subaward | Rural Focus |
|-------------|-------|---------------|--------------|-------------|-----------|---------------|-------------|
| TORCH | TX | 164 | $4.8M | 18 | TA, data, advocacy | $14M | Primary |
| Kentucky Hospital Assn | KY | 52 | $12.3M | 4 | Workforce, TA | $8M | Secondary |
| Georgia Hospital Assn | GA | 48 | $18.7M | 6 | Quality, HEART coord | $11M | Secondary |
| Ohio Hospital Assn | OH | 41 | $22.4M | 3 | Policy, data | $6M | Tertiary |
| Mississippi Hospital Assn | MS | 68 | $3.2M | 7 | TA, conversion support | $9M | Primary |
| North Carolina Hospital Assn | NC | 37 | $15.8M | 5 | Quality, workforce | $7M | Secondary |
| California Hospital Assn | CA | 89 | $45.2M | 4 | Policy, data | $5M | Tertiary |
| Montana Hospital Assn | MT | 48 | $2.1M | 8 | TA, network coord | $6M | Primary |
...
State approaches to hospital association RHTP subawards reveal different assumptions about the member advocacy tension.

| State | Subawardee | Award Amount | Functions | Pass-Through % | Outcome Accountability |
|-------|------------|--------------|-----------|----------------|------------------------|
| Texas | TORCH | $14.2M | Financial analysis, TA, data | 35% | Activity metrics |
| Georgia | GHA | $11.4M | Quality improvement, HEART | 28% | Quality measures |
| Kentucky | KHA | $8.1M | Workforce pipeline, TA | 42% | Training completion |
| Mississippi | MHA | $9.3M | Conversion support, TA | 31% | Conversions facilitated |
| North Carolina | NCHA | $7.2M | Quality, workforce | 38% | Composite metrics |
| Montana | MHA | $6.4M | Network coordination, TA | 25% | Network participation |
...
The Upper Peninsula Health Network in Michigan illustrates how hospital association advocacy can shape RHTP implementation in ways that protect members while potentially undermining transformation.
...
Despite the structural tensions, hospital associations contribute genuine transformation value under specific conditions.
...
The same structural features that enable association value-add can obstruct transformation.
...
Hospital associations are neither uniformly helpful nor uniformly harmful to RHTP transformation. **Their value depends on how subaward structures align advocacy incentives with transformation goals.**
...
Hospital associations bring genuine assets to RHTP implementation: member relationships, institutional knowledge, convening capacity, and technical expertise. **These assets have real value that states cannot easily replicate.**
...
- **Series 5** (State Agencies): 5A examines lead agency decisions about intermediary roles; 5C covers procurement approaches including association subawards
- **Series 7** (Healthcare Providers): 7A assesses CAH perspectives on association value; provider views test whether state-perceived value translates to community-experienced value
- **Series 3** (State Profiles): Texas, Georgia, Kentucky, Mississippi, and Michigan profiles detail state-specific association arrangements
- **Series 4** (Transformation Approaches): 4E examines hub and spoke networks where association advocacy shapes implementation

## Sources

American Hospital Association. "AHA 2024 IRS Form 990." AHA, Nov. 2024, aha.org/legal-documents/2024-11-06-american-hospital-association-2023-irs-form-990.

Bipartisan Policy Center. "The Rural Emergency Hospital Model: Year Two Progress Report." BPC, Oct. 2024, bipartisanpolicy.org/report/rural-emergency-hospital-year-two.

Georgia Department of Community Health. "Rural Hospital Tax Credit Program." DCH, 2025, dch.georgia.gov/programs/rural-hospital-tax-credit.

Georgia HEART. "Frequently Asked Questions." Georgia HEART, 2025, georgiaheart.org/about/page/frequently-asked-questions.

Health Resources and Services Administration. "Rural Health Grants: State Fact Sheets." HRSA, 2024, hrsa.gov/rural-health/about-us/state-fact-sheets.

National Rural Health Association. "About NRHA." NRHA, 2025, ruralhealth.us/about-nrha.

National Rural Health Association. "Rural Health Policy Institute." NRHA, 2026, ruralhealth.us/events/schedule/rural-health-policy-institute.

Texas Health and Human Services Commission. "Rural Hospital Finance." HHSC, 2024, hhs.texas.gov/providers/medicaid-business-resources/medicaid-supplemental-payment-directed-payment-programs/rural-hospital-finance.

Texas Organization of Rural and Community Hospitals. "Legislative Priorities." TORCH, 2025, torchnet.org/advocacy--legislative-priorities.html.

Texas Organization of Rural and Community Hospitals. "Hospital Dashboard." TORCH, 2025, torchnet.org/hospitaldashboard.html.

The Optimist. "Texas Rural Hospitals Await the Budget Cut Storm." Abilene Christian University, 31 Oct. 2025, acuoptimist.com/2025/10/texas-rural-hospitals-await-the-budget-cut-storm.

Wikipedia. "National Rural Health Association." Wikipedia, 5 Apr. 2025, en.wikipedia.org/wiki/National_Rural_Health_Association.

---

*RHTP Series 6: Intermediary Organizations*
*Rural Health Transformation Project*
*Article 6.A Version 2*
*January 2026*
