---
title: "Navigation and Burden"
date: 2026-08-06
author: "Syam Adusumilli"
summary: "What Systems Ask of Those Who Can Give the Least"
description: "RHTP Series 13: Navigation and Burden"
tags: ["rural-health", "rhtp", "health-equity", "series-13", "telehealth"]
categories: ["Rural Health Transformation"]
series: ["Series 13: Trust and Navigation"]
showtoc: true
tocopen: false
...
params:
  ...
  series_number: 13
  series_title: "Trust and Navigation"
  summary_url: "../navigation-and-burden-summary/"
...
The letter arrived on a Tuesday, explaining that Mountain Regional Health had upgraded its patient portal. All communications, test results, appointment requests, and prescription renewals would now be handled through MyChart. Patients should log in using their email address and create a secure password following the guidelines provided.
...
Navigation burden emerges from the interaction of multiple factors, some geographic, some systemic, and some reflecting assumptions embedded in how healthcare operates.
...
**1H Transportation and Mobility** provides foundational analysis of the transportation infrastructure gaps that create distance burden for rural healthcare access.

**4D Community Health Workers** examines the workforce approach most directly addressing navigation burden through human assistance with system navigation.

**7B Rural Health Clinics** analyzes the primary care access point that reduces distance burden when functioning effectively, and the consequences when clinics close.

**11D Chronic Disease Prevention** documents how navigation burden affects management of conditions requiring ongoing care and multiple specialist visits.

**14A Telehealth** assesses the innovation most often proposed for reducing distance burden, including evidence on whether it reduces or shifts burden.

## Sources

American Medical Association. "2024 Prior Authorization Physician Survey." AMA, Jan. 2025.

Arcury, Thomas A., et al. "Access to Transportation and Health Care Utilization in a Rural Region." *Journal of Rural Health*, vol. 21, no. 1, 2005, pp. 31-38.

Befort, Christie A., et al. "Impact of Distance and/or Travel Time on Healthcare Service Access in Rural and Remote Areas: A Scoping Review." *Journal of Transport & Health*, vol. 37, 2024, article 101819.

Chartis Center for Rural Health. "2025 Rural Health State of the State." Chartis, 2025.
...
Health of Health Index. "Administrative Burden in U.S. Healthcare: A Focus on Rural Systems and Workforce Sustainability." Health of Health, May 2025.

Medical Group Management Association. "Prior Authorization Landscape in 2025." MGMA, 2025.

Rural Health Information Hub. "Healthcare Access in Rural Communities." RHIH, 2024, www.ruralhealthinfo.org/topics/healthcare-access.
...
Weeks, William B., et al. "Distance Is Relative: Unpacking a Principal Barrier in Rural Healthcare." *Journal of General Internal Medicine*, vol. 19, no. 10, 2004, pp. 1019-1026.
