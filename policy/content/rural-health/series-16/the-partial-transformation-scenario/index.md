---
title: "The Partial Transformation Scenario"
date: 2026-08-23
author: "Syam Adusumilli"
summary: "What Happens When Some States Transform and Others Do Not"
description: "RHTP Series 16: The Partial Transformation Scenario"
...
cover:
  image: "cover.webp"
  alt: "The Partial Transformation Scenario"
  relative: true
  hidden: false
params:
  article_id: "RHTP-16C"
  ...
  summary_url: "../the-partial-transformation-scenario-summary/"
...
*Whitesburg, Kentucky sits twelve miles from the Virginia border. In 2032, the distance is measured in decades.*
...
*Dr. Sarah Okonkwo reviews the quarterly Rural Health Transformation Scorecard from her office at CMS. The map tells two stories.*
...
**RHTP 3 State Profiles:** State capacity variation that predicts clustering patterns across all 50 state implementation analyses.

**RHTP 5 State Agencies:** Implementation capacity variation that determines which states can execute complex transformation, particularly 5A Lead Agency Structures.

**RHTP 10 Regional Deep Dives:** Geographic variation context, particularly 10A Appalachian Mountains on multi-state fragmentation and 10D Mississippi Delta on cross-border challenges.

**RHTP 14 Alternative Architecture:** What transformation states implement, including 14A Inverse Hub, 14D Service Center, 14E Sovereign Investment, and 14G Tribal Demonstration.

**RHTP 15D Interstate Infrastructure:** Coordination limitations that partial transformation exposes and exacerbates.

**RHTP 15E Political Economy:** Political dynamics that produce state clustering and resistance to transformation.

**RHTP 16B Transformation Scenario:** What full transformation success would produce, against which partial transformation diverges.

**RHTP 16D Managed Decline Scenario:** What non-transformation states experience within the partial transformation scenario.
...
Commonwealth Fund. "Impact of the Medicaid Coverage Gap: Comparing States That Have and Have Not Expanded Eligibility." Commonwealth Fund, Sept. 2023, commonwealthfund.org.
...
Kaiser Family Foundation. "How Many Uninsured Are in the Coverage Gap and How Many Could Be Eligible if All States Adopted the Medicaid Expansion?" KFF, Aug. 2025, kff.org.

Lindrooth, Richard C., et al. "Understanding the Relationship Between Medicaid Expansions and Hospital Closures." Health Affairs, vol. 37, no. 1, 2018, pp. 111-120.
...
Center on Budget and Policy Priorities. "Closing Medicaid Coverage Gap Would Help Diverse Groups and Reduce Inequities." CBPP, July 2024, cbpp.org.
