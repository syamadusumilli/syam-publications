...
summary: "Building Beyond Healthcare While Depending on Healthcare Funding"
description: "RHTP Series 8: Community Development Organizations"
...
cover:
  image: "cover.webp"
  alt: "Community Development Organizations"
  relative: true
  hidden: false
params:
  article_id: "RHTP-8E"
  ...
  summary_url: "../community-development-organizations-summary/"
...
The tension cannot be fully resolved because it depends on what happens after 2030, which cannot be known. However, evidence from prior grant-funded programs suggests several patterns:

**Programs fully integrated into organizational mission survive at higher rates.** When grant-funded activities align with and strengthen core mission, organizations protect them after funding ends through reallocation from other sources. When grant-funded activities are peripheral, they are abandoned.

**Sustainability planning from program inception improves outcomes.** Organizations that build sustainability considerations into partnership design from the beginning fare better than those that address sustainability only when funding end approaches.

**Replacement funding for demonstrated programs exists in some cases.** Activities that document effectiveness and build stakeholder support sometimes attract replacement funding from states, foundations, or other federal programs. This is not guaranteed but is more likely for programs that invest in evaluation and relationship building.

## Organizational Capacity Analysis

| Organization | State/Region | Staff | Budget | Core Functions | Healthcare Role | RHTP Potential | Capacity Assessment |
|--------------|--------------|-------|--------|----------------|-----------------|----------------|---------------------|
| **Southern Bancorp** | AR, MS, TN, LA | ~400 | $42M+ | Banking, lending, community development | Housing, small business for health workforce | High | Strong infrastructure, established health connections |
| **Rural LISC** | National | ~50 rural-focused | $30M+ rural | Technical assistance, capital deployment | SDOH partnerships in 150+ communities | High | Scale and expertise; network model |
| **Fahe** | Appalachian region | ~60 | $25M | Housing finance, community development | Housing quality, stability programs | High | Regional scale, demonstrated health interest |
| **MAY Coalition** | Rural NC | 8 | $2.5M | Small business lending | Employment creation | Moderate | Mission-aligned but limited scale |
| **Federation of Appalachian Housing Enterprises** | Appalachia | 30 | $12M | Housing development, lending | Housing rehabilitation, healthy homes | High | Health connection established |
| **Mountain Association** | Eastern KY | 18 | $4M | Lending, business development | Food systems, economic resilience | Moderate | Mission-aligned, capacity constraints |
| **Hope Enterprise Corporation** | MS, AL, AR, LA, TN | ~200 | $50M+ | Banking, lending, policy | Housing, small business, health facilities | High | Scale, track record, health interest |
| **Coastal Enterprises Inc.** | ME | ~80 | $15M | Lending, fisheries, rural development | Food access, housing, healthcare facilities | High | Diverse portfolio, demonstrated capacity |

### What This Table Reveals

**Large, established CDFIs can absorb RHTP partnership** without organizational distortion. Southern Bancorp and Hope Enterprise Corporation have scale, diversified funding, and existing health-related activities that make RHTP alignment natural. For these organizations, RHTP represents enhancement of existing work rather than new direction.

**Mid-size regional organizations face strategic choices.** Fahe, Coastal Enterprises, and the Federation of Appalachian Housing Enterprises have sufficient capacity for meaningful partnership but must choose how much organizational attention to direct toward healthcare. These organizations can integrate RHTP activities without dependency if they maintain portfolio balance.

**Small community development organizations risk proportional dominance of healthcare funding.** An organization with $2 million budget receiving $500,000 in RHTP-related funding has 25% of revenue from a single source. This concentration creates the dependency risk the sustainability imperative view emphasizes.

## The SDOH Partnership Opportunity

### What RHTP Enables

RHTP explicitly emphasizes social determinants of health, creating opportunities for community development organizations that address those determinants:

**Housing organizations** can partner on healthy homes initiatives that connect housing rehabilitation with health outcomes. Lead paint remediation, weatherization, and accessibility modifications all improve health while aligning with housing mission.

**CDFIs** can finance healthcare workforce housing, medical facilities in underserved areas, and small businesses that provide healthcare employment. Loan products for healthcare-related purposes fit CDFI models while serving RHTP goals.

**Economic development entities** can focus on healthcare sector development, connecting workforce training with healthcare employment needs. Employer recruitment can prioritize healthcare operations that bring both jobs and services to rural areas.

**Community land trusts** can incorporate health considerations into property selection and development, prioritizing locations with access to healthcare services and amenities that support health.

### What RHTP Risks

**Healthcare colonization of community development** occurs when healthcare funding reshapes organizations around healthcare priorities rather than community development mission. Signs of colonization include:

Healthcare partners directing organizational strategy rather than collaborating. Staff evaluation based on healthcare metrics rather than community development outcomes. Board composition shifting toward healthcare expertise at expense of community development knowledge. Organizational identity becoming healthcare-adjacent rather than community development-centered.

**Funding concentration creates vulnerability** even when activities align with mission. An organization doing exactly what it should do becomes fragile if the funding for that work comes predominantly from one source.

**Reporting burdens distort attention** when RHTP documentation requirements consume staff time that would otherwise go to core activities. Community development organizations typically have limited administrative capacity. Healthcare reporting demands may exceed what small organizations can absorb without reducing program delivery.

### Vignette: The CDFI Partnership Decision

*Appalachian Community Lending (a composite drawn from multiple organizations) has provided small business and housing loans in eastern Kentucky for 25 years. The organization has 12 staff, a $6 million operating budget funded by CDFI Fund awards, foundation grants, loan interest, and fee income. It has never worked directly with healthcare systems.*

*Kentucky's RHTP implementation identifies housing quality as a priority intervention. The state seeks CDFI partners to manage healthy homes financing, providing $800,000 annually for three years to support lending for housing rehabilitation that addresses health hazards.*

*ACL's leadership debates the opportunity:*

**The opportunity case:** Housing rehabilitation is core mission. The funding aligns with what ACL does. Three years of enhanced lending capacity could demonstrate a model that attracts ongoing foundation or state support. Healthcare connection could open new funding streams. Declining means another organization gets the resources and the relationship.

**The caution case:** $800,000 is 13% of budget. That is meaningful concentration. The funding requires healthcare-specific reporting ACL has never done. Staff will need training. The healthcare partnership may reshape expectations. What happens in year four when funding ends but community expects continued program?

*ACL leadership decides to accept with conditions: (1) no more than 20% of total budget from healthcare-related funding; (2) sustainability planning begins immediately, with explicit goal of identifying replacement funding; (3) reporting systems built to serve ACL purposes, not only funder requirements; (4) healthcare partnership structured as collaboration, not direction.*

*Three years later, ACL has built healthy homes expertise, established relationships with healthcare partners, and demonstrated outcomes. A regional foundation provides bridge funding while ACL pursues HUD healthy homes grants. The healthcare funding ended; the capacity persists. The conditions that structured the partnership protected organizational integrity.*

**What the vignette reveals:** Strategic partnership with explicit sustainability planning can work. The key is not avoiding partnership but structuring it to prevent dependency and mission distortion.

## RHTP Role Analysis

### Current RHTP Engagement by State

| State | Community Development Role | Funding Mechanism | Functions | Evidence |
|-------|---------------------------|-------------------|-----------|----------|
| **Arkansas** | Southern Bancorp as major partner | Subaward | Housing, small business, health workforce | Established partnership |
| **Kentucky** | Housing organizations for healthy homes | Subaward | Lead remediation, weatherization | Alignment with existing programs |
| **Mississippi** | Hope Enterprise Corporation engaged | Subaward/partner | Community facilities, housing | Ongoing relationship |
| **West Virginia** | CDFIs for housing quality | Subaward | Housing rehabilitation | Limited scale |
| **North Carolina** | Regional CDFIs for SDOH | Subaward | Food access, housing | Multiple organizations |
| **Texas** | Limited CDFI engagement | Minimal | Workforce housing discussion | Underdeveloped |

### What This Analysis Reveals

**States with established community development infrastructure engage CDFIs more effectively.** Arkansas and Mississippi have strong regional CDFIs that already operate at scale and have existing relationships with state agencies. Partnership emerges from infrastructure that exists rather than being created for RHTP purposes.

**States without community development infrastructure cannot manufacture it.** Texas has minimal rural CDFI presence relative to its rural population. RHTP cannot create community development organizations that do not exist. Where infrastructure is absent, transformation must proceed through other mechanisms.

**Healthcare-community development partnerships require translation.** Healthcare systems and community development organizations use different language, measure different outcomes, and operate under different regulatory frameworks. Effective partnership requires investment in relationship building and mutual education that neither RHTP timelines nor budgets may accommodate.

## Alternative Perspective: The Grant Dependency Skepticism

**Many organizations taking RHTP funds will not survive funding end.** The history of federal grant programs suggests that community organizations built around temporary funding frequently collapse. RHTP's five-year timeline is too short to establish sustainability. Organizations taking RHTP funds are setting themselves up for failure.

**Strongest version of this view:** Community development organizations are already fragile. Adding healthcare funding creates apparent capacity that is actually fragile dependency. When funding ends, organizations will have grown to meet RHTP requirements, making the contraction more painful than if they had never participated. Better to build slowly on sustainable revenue than quickly on temporary grants.

**Assessment of this perspective:** The skepticism has substantial historical support. Grant-dependent organizations do frequently fail when grants end. However, the categorical rejection of grant-supported capacity building ignores variation in organizational response. Some organizations do build sustainable capacity through grant-funded periods. The question is what distinguishes organizations that sustain from those that collapse.

Evidence suggests:

**Organizations with diversified funding before RHTP manage RHTP funding better.** Established CDFIs with multiple revenue sources can absorb RHTP funding without concentration. New or struggling organizations that see RHTP as salvation face higher failure risk.

**Mission alignment predicts sustainability.** Activities that align with organizational mission get protected after funding ends. Activities that were pursued only because funding was available get abandoned.

**Leadership matters.** Organizations with leaders who understand sustainability risks and plan for them fare better than those that defer sustainability thinking until funding end approaches.

## State and Regional Variation

### Why Capacity Varies

| Factor | Effect on Community Development Capacity | Examples |
|--------|----------------------------------------|----------|
| **Population density** | Thin markets limit CDFI viability | Great Plains states have few CDFIs |
| **Economic conditions** | Stronger economies support more lending | Upper Midwest has better CDFI presence |
| **Federal program history** | Areas with CDFI Fund investment have infrastructure | Mississippi Delta has Hope Enterprise |
| **Foundation presence** | Philanthropic investment builds capacity | Appalachia has foundation support |
| **State policy** | State CDFI tax credits and programs add resources | Louisiana, NC have state programs |

### Vignette: Same Organization Type, Different Contexts

*Two regional CDFIs serve rural areas with different characteristics:*

**Delta CDFI (Mississippi Delta):** Operates in persistent poverty region with 25% poverty rate, limited banking presence, and weak economy. Demand for credit exceeds supply. CDFI cannot meet all requests. Healthcare partnership offers resources but market conditions mean CDFI would deploy capital regardless. RHTP funding enhances capacity but does not fundamentally change operations. When funding ends, CDFI continues serving market that has always needed more capital than available.
...
**Series 4:** RHTP 4.H Social Needs Integration examines healthcare system approaches to SDOH
**Series 6:** RHTP 6.A through 6.F examine intermediary organizations that sometimes partner with community development entities
**Series 3:** State profiles identify community development capacity variations across states
**Series 8:** RHTP 8.G Alternative Ownership Models examines cooperatives and community land trusts in more depth

## Sources

CDFI Fund. "FY 2024 Annual Report." U.S. Department of the Treasury, 2025.

CDFI Coalition. "General CDFI Fact Sheet." CDFI Coalition, March 2025. cdfi.org/wp-content/uploads/2025/03/General-CDFI-Fact-Sheet-March-2025.pdf

CNote. "Social Determinants of Health and Community Finance." CNote, April 2025. mycnote.com/blog/social-determinants-of-health-community-finance

Congressional Research Service. "Community Development Financial Institutions (CDFIs): Overview and Selected Issues." CRS Report R47217, 2024.
...
National Organization of State Offices of Rural Health. "Rural Health Capital Resources Council Project." NOSORH, 2024. nosorh.org/rural-health-capital-resources-council-project

Opportunity Finance Network. "CDFIs Make Dreams Come True by Creating Opportunity in Rural Spaces." Rural Health Information Hub, Rural Monitor, 2023.

Rose, Justin, et al. "Mechanisms to Improve Health Through Community Land Trusts." Journal of Urban Health, vol. 100, 2023, pp. 185-196.

Rural Health Information Hub. "Economic Development." SDOH Toolkit, 2024. ruralhealthinfo.org/toolkits/sdoh/2/economic-stability/economic-development

Urban Institute. "Do Community Land Trusts Improve Resident Outcomes?" Housing Matters, February 2024.

---

*RHTP 8.E: Community Development Organizations*
*Series 8: Community Organizations*
