...
summary: "Sovereignty vs. Federal Program Requirements"
description: "RHTP Series 8: Tribal and Indigenous Organizations"
tags: ["rural-health", "rhtp", "social-care", "series-8", "sdoh", "telehealth"]
...
cover:
  image: "cover.webp"
  alt: "Tribal and Indigenous Organizations"
  relative: true
  hidden: false
params:
  article_id: "RHTP-8H"
...
Tribal nations have community organizations serving functions beyond formal health services. These organizations represent potential partners for RHTP implementation, if partnership can respect sovereignty while meeting program requirements.
...
| Organization Type | Estimated Count | Primary Health Role | RHTP Relevance |
|-------------------|-----------------|---------------------|----------------|
| Tribal colleges | 35 | Workforce training, health education | High for workforce development |
| CHR programs | ~1,600 CHRs | Community outreach, basic services | High for CHW strategies |
| Tribal housing authorities | ~200 | SDOH (housing conditions) | Moderate for housing-health integration |
| Tribal Head Start | ~150 programs | Early childhood health | Moderate for maternal/child health |
| Tribal elder programs | ~400+ | Nutrition, transportation, support | High for aging-in-place |
| Tribal behavioral health | Varies widely | Mental health, SUD treatment | High for behavioral health integration |

## Urban Indian Organizations: The Forgotten Sector

Approximately **70% of American Indians and Alaska Natives now live in urban areas**, yet the urban Indian health sector receives only **1% of the IHS budget**. The 41 Urban Indian Organizations (UIOs) operating 85 facilities in 38 urban areas represent the primary healthcare infrastructure for urban Native populations.
...
UIOs fall outside RHTP's rural focus. Urban Native populations may not benefit from transformation investments despite experiencing similar health disparities. However:

**Urban-rural connection matters.** Many tribal members move between urban and reservation areas. Care coordination across settings affects outcomes. RHTP investments in rural tribal health could create infrastructure that urban Native populations access during time on reservations.

**Some UIOs serve rural-adjacent populations.** UIO service areas sometimes include surrounding rural counties. Clear urban/rural boundaries do not match Native population mobility.

**UIO models could inform rural approaches.** UIOs have developed care coordination, cultural integration, and community health models that could adapt to rural tribal settings. Learning flows both directions.

## The Partnership Tension

RHTP operates through states. Tribal health operates through direct federal-to-tribal relationships. This structural difference creates fundamental tension when states seek to partner with tribal organizations for transformation.

### What Tribes Gain From Participation

**Resources.** RHTP funding could supplement chronically underfunded tribal health programs. If participation does not compromise sovereignty, additional resources benefit tribal communities.

**Coordination.** Many tribal members receive care from both tribal and non-tribal providers. RHTP investments in care coordination, health information exchange, and referral relationships could reduce fragmentation.

**Workforce development.** Tribal communities face severe workforce shortages. RHTP workforce investments could include tribal-specific training pathways, loan repayment incentives, and community health worker programs.

**Infrastructure.** Telehealth, broadband, and technology investments benefit tribal communities that often lack infrastructure. Tribal participation in statewide technology initiatives could accelerate infrastructure development.

### What Tribes Risk From Participation

**Sovereignty compromise.** State-administered programs may impose requirements that conflict with tribal approaches. Accepting state oversight of tribal health activities contradicts self-determination principles.

**Reporting burdens.** Federal programs already impose substantial reporting requirements on tribal programs. Adding state RHTP reporting creates additional administrative burden without additional administrative resources.

**Cultural mismatch.** State-designed programs may not accommodate cultural practices, traditional healing, or tribal definitions of health and wellness. Forcing tribal participation into state-defined frameworks undermines culturally-responsive care.

**Accountability confusion.** Tribes are accountable to their members through tribal governance. Adding state accountability creates multiple, potentially conflicting, accountability relationships.

### The Sovereignty Debate

*Navajo Nation Health Department received invitation to participate in Arizona's RHTP implementation. The state proposed substantial resources: workforce development funding, telehealth infrastructure, and care coordination support. In exchange, Navajo programs would report to state oversight, meet state-defined metrics, and coordinate with state-designated regional entities.*

*Tribal council debate was intense. One faction argued for participation: resources were needed, coordination was valuable, and declining would leave Navajo communities without RHTP benefits while Arizona's other rural areas received transformation investment. Another faction argued against: accepting state oversight undermined a century of work toward self-determination, metrics designed for non-tribal populations would not capture Navajo health values, and state coordination mechanisms would dilute Navajo control of Navajo health.*

*The council sought a third path: direct federal-to-tribal RHTP funding that would bypass state administration. CMS guidance was unclear. The question remained unresolved as planning deadlines approached.*

## Alternative Perspective: The Integration View

The sovereignty-first perspective has critics who argue that prioritizing sovereignty over pragmatic partnership harms tribal communities.

**Integration enables resources.** Tribal communities need healthcare resources urgently. The 8.3-year life expectancy gap between American Indian and Alaska Native populations and national averages represents ongoing crisis. Refusing participation that could reduce this gap because of sovereignty concerns prioritizes principle over outcomes.

**Coordination requires connection.** Tribal members increasingly receive care across tribal and non-tribal settings. Refusing to coordinate with state systems creates fragmentation that harms patients. Effective care coordination may require some accommodation of state processes.

**Isolation perpetuates marginalization.** Maintaining separate systems reinforces separation that has historically served tribal communities poorly. Strategic integration preserves tribal identity while enabling partnership that could improve outcomes.

**Sovereignty does not require isolation.** Self-determination means tribes choose their own path. If tribal leadership determines that partnership with state RHTP serves tribal interests, that choice is itself an exercise of sovereignty.

**Assessment:** The integration view has partial validity. Tribal communities do need resources urgently. Coordination does benefit patients. Isolation is not inherently valuable. However, the integration view underestimates the history that makes sovereignty concerns not abstract but existential. Federal and state programs designed for tribal communities without tribal control have consistently failed or harmed those communities. Tribal caution about state-administered programs reflects experience, not paranoia. The solution is not tribal accommodation of state programs, but state accommodation of tribal sovereignty.

## Capacity Assessment: Tribal Community Organizations

| Organization | Type | State/Region | Staff | Budget | Healthcare Role | RHTP Potential | Capacity Assessment |
|--------------|------|--------------|-------|--------|-----------------|----------------|---------------------|
| Navajo Nation CHR | CHR program | AZ, NM, UT | 250+ CHRs | ~$15M | Community outreach, basic care | High | High: established program, large scale |
| Seattle Indian Health Board | UIO | WA | 300+ | ~$40M | Comprehensive ambulatory | Moderate (urban) | High: strong organization |
| Cherokee Nation Health | Tribal health | OK | 4,000+ | ~$700M | Integrated system | High | High: major capacity |
| Southcentral Foundation | Tribal health | AK | 2,300+ | ~$400M | Nuka System of Care | High | High: nationally recognized model |
| First Nations Community HealthSource | UIO | NM | ~150 | ~$15M | Primary care, behavioral | Moderate | Moderate: growing capacity |
| Tribal colleges (aggregate) | Higher education | Multiple | Varies | Varies | Workforce training | High | Moderate: capacity varies |
| Alaska CHAP | CHW program | AK | 500+ CHAs | ~$30M | Community Health Aides | High | High: proven CHAP model |

## The Community Health Aide Program: A Model Worth Understanding

The Alaska Community Health Aide Program (CHAP) represents perhaps the most successful community health worker model in the United States and offers lessons for rural health transformation beyond tribal settings.

**CHAP trains Community Health Aides and Practitioners (CHA/Ps)** to provide primary care services in remote Alaska villages where physicians and nurses cannot be recruited. Approximately **550 CHA/Ps** serve over **170 villages** across Alaska. CHA/Ps provide services including emergency stabilization, chronic disease management, prenatal care, health education, and basic procedures.

The program operates under a sophisticated supervision structure. CHA/Ps work with remote physician oversight through telehealth and consultation protocols. Training occurs in stages, with aides advancing through four levels of certification. **Dental Health Aide Therapists (DHATs)** extend the model to dental care, performing procedures traditionally reserved for dentists.

**Outcomes demonstrate effectiveness.** Tribal health organizations operating CHAP have achieved vaccination rates, chronic disease management outcomes, and patient satisfaction levels comparable to or exceeding national benchmarks. The model proves that community-based workers with structured training and supervision can deliver quality care.

**Expansion beyond Alaska faces obstacles:**

**State scope of practice laws.** CHAP operates under federal authorization that preempts state scope of practice restrictions within tribal health programs. Expanding the model to non-tribal settings or other states requires navigating scope of practice laws that were designed before CHAP existed.

**Training infrastructure.** Alaska has built CHAP training capacity over decades. Other states lack equivalent infrastructure.

**Cultural context.** CHAP emerged from Alaska Native communities and reflects their values and relationships. Transplanting the model requires cultural adaptation that cannot simply replicate Alaska's approach.

**RHTP could support CHAP expansion where appropriate.** States with significant tribal populations could invest in Community Health Aide training aligned with tribal health needs. The model's proven outcomes justify investment. Expansion requires tribal partnership, not state imposition.

## When Tribal Organizations Can Support Transformation

Tribal and indigenous community organizations can contribute to rural health transformation when specific conditions exist:
...
Tribal and indigenous community organizations cannot support RHTP transformation when conditions preclude meaningful participation:
...
Article 2E: Indian Health Service and Tribal Health Systems for detailed IHS analysis
Series 9B: Tribal and Indigenous Communities for population-focused examination
Series 4D: Community Health Workers for CHW model analysis including CHAP
Series 5: State Agencies for tribal consultation requirements

## Sources

Centers for Medicare and Medicaid Services. "Rural Health Transformation Program: Tribal Consultation Requirements." 2025.

Government Accountability Office. "Indian Health Service: Spending Levels and Characteristics of IHS and Three Other Federal Health Care Programs." GAO-19-74, 2018.

Indian Health Service. "IHS Profile." Accessed January 2026. https://www.ihs.gov/

Indian Health Service. "Tribal Self-Governance." Accessed January 2026. https://www.ihs.gov/selfgovernance/

National Congress of American Indians. "Tribal Nations and the United States: An Introduction." 2020.

National Council of Urban Indian Health. "2025 Advocacy Priorities." Accessed January 2026.

National Indian Health Board. "Tribal Budget Formulation Recommendations." FY2026.

Roubideaux, Yvette. "Self-Determination and Health Care." New England Journal of Medicine, 2021.

Southcentral Foundation. "The Nuka System of Care." Accessed January 2026. https://www.southcentralfoundation.com/nuka/

Supreme Court of the United States. "Becerra v. San Carlos Apache Tribe." June 2024.

Urban Indian Health Institute. "Community Health Profile: National Aggregate." 2021.

U.S. Department of Health and Human Services. "FY2026 Budget in Brief: Indian Health Service." 2025.
