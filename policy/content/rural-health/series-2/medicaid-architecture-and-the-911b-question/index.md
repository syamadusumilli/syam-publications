---
title: "Medicaid Architecture and the $911B Question"
date: 2026-01-16
author: "Syam Adusumilli"
summary: "The Math That Does Not Add Up"
description: "RHTP Series 2: Medicaid Architecture and the $911B Question"
tags: ["rural-health", "rhtp", "series-2", "medicaid", "medicare", "telehealth"]
...
cover:
  image: "cover.webp"
  alt: "Medicaid Architecture and the $911B Question"
  relative: true
  hidden: false
params:
  article_id: "RHTP-2B"
  ...
  summary_url: "../medicaid-architecture-and-the-911b-question-summary/"
  collection: "rural-health"
---

> *"Fifty billion dollars over five years does not equate to $155 billion over ten years. This particular issue was almost a shell game aspect of the legislation."*
...
**The One Big Beautiful Bill Act freezes provider taxes.** States cannot increase provider tax rates or implement new provider taxes. In expansion states, the hold harmless safe harbor threshold phases down from 6 percent to lower levels over time.

Provider tax restrictions reduce state fiscal capacity exactly when the enhanced FMAP reduction increases state obligations. States cannot raise new revenue to cover increased state share requirements. The combination forces benefit and eligibility cuts.
...
**Georgia implemented partial expansion** with work requirements in 2023, the Georgia Pathways program. Coverage extends to adults meeting work requirements. The approach captures some federal matching while maintaining work requirement ideology. Results have been modest: enrollment far below projections, administrative costs high, coverage gains limited.
...
- Congressional Budget Office, Information Concerning Budgetary Effects of H.R. 1 (July 2025)
...
- Center for American Progress, The Truth About the One Big Beautiful Bill Act's Cuts (August 2025)
- FactCheck.org, Rural Health Fund Falls Short of Estimated Medicaid Cuts (September 2025)
- Manatt Health analysis for National Rural Health Association
- American Hospital Association, Impact of Proposed Medicaid Cuts on Rural Patients (June 2025)
- ASTHO, One Big Beautiful Bill Law Summary
- State application documents and progress reports
- Alan Morgan interview, Daily Yonder (October 2025)

*This is Article 2B in Series 2: Federal Policy Architecture. The series continues with Article 2C: Medicare Rural Provisions.*
