---
title: "Federal Rural Health Program Coordination Matrix"
date: 2026-01-25
author: "Syam Adusumilli"
summary: "Document Overview"
description: "RHTP Series 2: Federal Rural Health Program Coordination Matrix"
tags: ["rural-health", "rhtp", "series-2", "technical-document", "medicaid", "medicare", "telehealth"]
...
cover:
  image: "cover.webp"
  alt: "Federal Rural Health Program Coordination Matrix"
  relative: true
  hidden: false
params:
  article_id: "RHTP-2-TD-B"
  article_type: "technical_document"
  series_number: 2
  series_title: "The Federal Architecture of Rural Health"
  summary_url: "../federal-rural-health-program-coordination-matrix-summary/"
...
| **Rural Residency Planning & Development** | ~$10 million | Training pipeline | Academic medical centers |
...
- **CAH status + RHTP funding**: CAHs can receive RHTP transformation dollars while maintaining cost-based reimbursement
- **NHSC placement + RHTP workforce**: NHSC clinicians can work at RHTP-funded sites; RHTP cannot duplicate loan repayment
- **FQHC + RHTP**: FQHCs can participate in state transformation networks while receiving Section 330 funding
- **DLT equipment + RHTP telehealth**: USDA can fund equipment while RHTP funds operations/staffing

**Prohibited Combinations:**
- **RHTP backfill**: RHTP cannot replace existing revenue streams (Medicaid, Medicare, private pay)
- **Duplicate loan repayment**: State RHTP loan repayment cannot stack with federal NHSC for same debt
- **Double capital funding**: Same construction project cannot receive both RHTP capital and Community Facilities loan for identical costs

**Coordination Requirements:**
- States must document non-duplication in RHTP budget narratives
- NHSC site approval requires demonstration of sustainable funding post-award
- FQHCs receiving RHTP must maintain Section 330 compliance
...
- Non-duplication certification in RHTP applications
- Cross-program coordination narrative
- Letters of support from SORH, CHC networks
- Tribal consultation documentation

**Organizational Alignment:**
- SORH involvement in RHTP governance
- FQHC representation on advisory committees
- AHEC integration for workforce planning
- Extension service coordination for community health

**Reporting Harmonization:**
- Align RHTP metrics with UDS where applicable
- Use Flex quality measures for CAH participants
- Coordinate workforce tracking across NHSC and state programs
...
- RHTP annual guidance updates program parameters
- Congressional appropriations significantly alter program funding
- HHS reorganization affects program administration
- New rural health programs are authorized
...
| **2-TD-B** | Federal Rural Health Program Coordination Matrix | *This document* |
| **1-TD-B** | Rural Classification Reference Guide | Federal rural definitions and program eligibility |

*Technical Document 2-TD-B*
