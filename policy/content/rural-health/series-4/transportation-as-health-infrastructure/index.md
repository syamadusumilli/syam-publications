...
summary: "What moves people when transit doesn't exist?"
description: "RHTP Series 4: Transportation as Health Infrastructure"
tags: ["rural-health", "rhtp", "series-4", "medicaid", "sdoh", "telehealth"]
...
cover:
  image: "cover.webp"
  alt: "Transportation as Health Infrastructure"
  relative: true
  hidden: false
params:
  article_id: "RHTP-4I"
  ...
  summary_url: "../transportation-as-health-infrastructure-summary/"
  collection: "rural-health"
---

*What moves people when transit doesn't exist?*
...
The rural transportation system is, for most residents, a personal automobile. **Over 90% of rural households own at least one vehicle**, and most rural trips occur via private car. This near-universal vehicle dependence shapes community design, service location, and health access assumptions.
...
Transportation barriers concentrate among populations with the greatest healthcare needs:
...
Rural transportation barriers intensify seasonally. Winter weather renders roads impassable, grounds air transport, and makes travel dangerous for elderly drivers. Mountain communities become isolated when passes close. Plains communities face blizzards that prevent any travel for days.
...
|--------------|------------------|-------------|----------------|--------------------------|
| Medicaid NEMT (chronic disease) | Moderate | Moderate | Yes | Established |
| Volunteer driver programs | Limited | Moderate | Yes | Moderate |
| Mobile health units | Moderate | Access improvement | Yes | High |
| Community paramedicine | Limited | Variable | Yes | High |
| Rideshare partnerships | Limited | Small | Urban only | Low |
| Telehealth as transport substitute | Moderate | Moderate | Yes | See 4C |
| Treat-in-place models | Emerging | Unknown | Yes | Variable |
| Transportation brokerage | Moderate | Process improvement | Yes | Established |

### Non-Emergency Medical Transportation

NEMT represents the most studied rural transportation intervention because Medicaid requires states to ensure transportation access for beneficiaries. Federal regulations mandate that state Medicaid programs provide NEMT for eligible members who have no other means of reaching covered healthcare services.
...
Telehealth substitutes for some transportation by eliminating the need for travel. When effective, telehealth represents not reduced transportation burden but eliminated transportation burden. Article 4C examines telehealth evidence comprehensively; transportation implications receive summary treatment here.
...
| Model | Cost per Trip | Availability | Flexibility | Rural Applicability |
|-------|---------------|--------------|-------------|---------------------|
| Medicaid NEMT broker | $30-60 | Scheduled (48h advance) | Low | Established |
| Volunteer driver program | $10-25 | Limited to volunteers | High | Good (if volunteers exist) |
| Transit authority service | Variable | Schedule-dependent | Low | Limited |
| Mobile health unit | N/A | Location-dependent | High | Good |
| Community paramedicine | $150-300 | On-demand | High | Moderate |
| Rideshare partnership | $15-40 | Immediate (if available) | High | Poor |

## State Program Examples

### West Virginia: Rural Health Link
...
Iowa's RHTP application emphasizes mobile integrated healthcare bringing care to communities rather than transporting patients to facilities. The **EMS Community Care Mobile** initiative focuses on high-risk maternal transport telehealth for mothers and newborns requiring higher levels of care, mobile integrated healthcare delivering prenatal, postpartum, and chronic disease management to homes and community sites, and post-surgery discharge support through mobile teams.
...
Maine has invested in volunteer driver programs through initiatives like the **Community Care program** that coordinate volunteer transportation across rural regions. The state's geography, with dispersed coastal and inland populations, makes traditional transit impractical for much of the state.
...
### Prevalence of Transportation Initiatives

Transportation appears in RHTP applications primarily through indirect mechanisms rather than dedicated transportation investments:
...
**Infrastructure investment** in roads, vehicles, and transportation systems falls outside RHTP scope. States cannot use RHTP funding to pave rural roads, purchase transit vehicles, or establish bus routes. The transformation program can coordinate transportation resources but cannot create transportation infrastructure.
...
**Coordination over construction** represents the achievable RHTP transportation strategy. States cannot build transit systems in five years, but they can coordinate existing resources more effectively. Unified scheduling platforms, shared dispatch systems, and coordinated trip planning can extract more value from existing transportation assets.
...
**Programs dependent on resources that do not exist** cannot succeed. Volunteer driver programs in communities without volunteers, rideshare partnerships in areas without rideshare drivers, and coordination platforms connecting services that have not been established all fail at the resource level rather than the design level.
...
Transportation presents among the most difficult RHTP sustainability challenges. Healthcare organizations cannot operate transportation systems at scale. Transit agencies lack healthcare expertise. Medicaid NEMT is a benefit rather than an infrastructure program. **No entity is positioned to assume permanent responsibility for rural health transportation.**
...
RHTP can improve rural transportation at the margins. Coordination will extract more value from existing resources. Mobile services will reach some patients who could not otherwise receive care. Community paramedicine will divert some emergency transports. Telehealth will eliminate some trips.
...
**Related Series 1 Foundation Articles**
- [1H](/rural-health/series-1/article-1h-transportation-and-mobility/): Transportation and Mobility (baseline rural transportation context)

**Related Series 2 Federal Policy Architecture**
- [2B](/rural-health/series-2/article-2b-medicaid-architecture-and-the-911b-question/): Medicaid Architecture and the $911B Question (NEMT benefit structure)
- [2H](/rural-health/series-2/article-2h-the-2030-cliff/): The 2030 Cliff (transportation program sustainability)

**Related Series 4 Transformation Approaches**
- [4C](/rural-health/series-4/rhtp-4c-telehealth-and-virtual-care/): Telehealth and Virtual Care (transportation substitution potential)
- [4H](/rural-health/series-4/rhtp-4h-social-needs-integration/): Social Needs Integration (transportation as SDOH)
- [4K](/rural-health/series-4/rhtp-4k-emergency-and-trauma-systems/): Emergency and Trauma Systems (emergency medical transport)
- [4A](/rural-health/series-4/rhtp-4a-aging-in-place/): Aging in Place (elderly transportation needs)
- [4D](/rural-health/series-4/rhtp-4d-community-health-workers/): Community Health Workers (CHW transportation navigation)

**Series 3 State Profiles with Notable Transportation Initiatives**
- 3.WV: West Virginia (Rural Health Link platform)
- [3.IA](/rural-health/series-3/rhtp-3ia-iowa/): Iowa (EMS Community Care Mobile)
- [3.ME](/rural-health/series-3/rhtp-3me-maine/): Maine (Community Care volunteer model)
- [3.MT](/rural-health/series-3/rhtp-3mt-montana/): Montana (frontier NEMT challenges)

## Sources

Agency for Healthcare Research and Quality. "Social Determinants of Health: Transportation Insecurity." AHRQ, 2024, ahrq.gov/sdoh/data-analytics/transportation.html.

Bureau of Transportation Statistics. "85% of Rural Residents Have Reasonable Access to Intercity Transportation; Lack of Reasonable Access Falls Disproportionately on Low-Income Households." BTS Data Spotlight, 2022, bts.gov/data-spotlight.

Center for Health Care Strategies. "Making a Case for Community Paramedicine: Evidence Roundup." CHCS, Dec. 2024, chcs.org/resource/making-case-community-paramedicine.

Center for Health Care Strategies. "Leveraging Community Paramedicine to Address Rural Health Needs." CHCS, Oct. 2025, chcs.org/resource/leveraging-community-paramedicine.

Flex Monitoring Team. "The Evidence for Community Paramedicine in Rural Areas: State and Local Findings and the Role of the State Flex Program." University of Minnesota Rural Health Research Center, 2014.

Gregg, Abbey, et al. "Systematic Review of Community Paramedicine and EMS Mobile Integrated Health Care Interventions in the United States." *Population Health Management*, vol. 22, no. 3, June 2019, pp. 213-222.

Iowa Department of Health and Human Services. "Rural Health Transformation Program Application." Iowa HHS, 2025.

Medical Transportation Access Coalition. "NEMT Bibliography: Research on Non-Emergency Medical Transportation." MTAC, June 2024, mtaccoalition.org.

Milliman. "The Road to Care: An Analysis of Non-Emergency Medical Transportation Delivery Systems." Milliman Research Report, 2025.

National Aging and Disability Transportation Center. "Volunteer Transportation Resources." NADTC, 2024, nadtc.org/volunteer-transportation.

National Rural Health Association. "Bridging the Gap: A Policy Framework for Sustainable Community Paramedicine in Rural America." NRHA Policy Brief, Dec. 2024.

Rural Health Information Hub. "Community Paramedicine Overview." RHIhub, 2025, ruralhealthinfo.org/topics/community-paramedicine.

Rural Health Information Hub. "Volunteer Models for Rural Transportation." RHIhub Transportation Toolkit, 2024, ruralhealthinfo.org/toolkits/transportation.

Rural Policy Research Institute. "Transit for Healthcare: Volunteer Drivers in Aging Rural Minnesota." Center for Rural Policy and Development, Sept. 2020.

Small Urban and Rural Transit Center. "Rural Transit Fact Book 2025." North Dakota State University Upper Great Plains Transportation Institute, June 2025.

Solomon, E., et al. "Impact of Transportation Interventions on Health Care Outcomes: A Systematic Review and Meta-Analysis." *Medical Care*, vol. 58, no. 4, 2020, pp. 384-391.

Thomas, L.V., and K.R. Wedel. "Nonemergency Medical Transportation and Health Care Visits Among Chronically Ill Urban and Rural Medicaid Beneficiaries." *Social Work in Public Health*, vol. 29, no. 6, 2014, pp. 629-639.

West Virginia Bureau for Public Health. "Rural Health Transformation Program Application: Connected Care Grid and Rural Health Link." WVBPH, 2025.


*RHTP 4.I: Transportation as Health Infrastructure*
