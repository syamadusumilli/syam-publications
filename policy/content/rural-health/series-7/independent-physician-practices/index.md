...
summary: "The Last Generalists and the Accountability Gap"
description: "RHTP Series 7: Independent Physician Practices"
tags: ["rural-health", "rhtp", "series-7", "medicare", "telehealth"]
categories: ["Rural Health Transformation"]
series: ["Series 7: Rural Provider Landscape"]
showtoc: true
tocopen: false
...
cover:
  image: "cover.webp"
  alt: "Independent Physician Practices"
  relative: true
  hidden: false
params:
  article_id: "RHTP-7D"
  ...
  series_number: 7
  series_title: "Rural Provider Landscape"
  summary_url: "../independent-physician-practices-summary/"
...
The Physicians Advocacy Institute and Avalere documented a transformation in rural physician practice between January 2019 and January 2024:

| Metric | 2019 | 2024 | Change |
|--------|------|------|--------|
| Total rural physicians | 52,600 | 50,100 | -5% |
| Independent rural physicians | 21,956 | 12,467 | -43% |
| Independent rural practices | 17,400 | 10,100 | -42% |
| Hospital/health system employed | 48% | 58% | +10 pts |
| Corporate entity employed | 11% | 18% | +7 pts |
...
Independent rural physicians in 2026 fall into recognizable categories:
...
The forces driving employment consolidation are well-documented but bear repeating:
...
**The Provider Autonomy View:** Independent physicians provide care unconstrained by corporate protocols, production quotas, or organizational politics. They can spend time with complex patients without productivity pressure. They can adjust treatment approaches based on individual knowledge rather than standardized guidelines. They maintain relationships that enable trust and disclosure. Patient need is best served by autonomous practitioners who answer to patients, not institutions.
...
Independent rural physicians operating under fee-for-service payment face incentive structures that can diverge from patient welfare:
...
Employed physicians face multiple accountability mechanisms:
...
*Dr. Sarah Chen operates an independent family practice in Moberly, Missouri, population 13,000. She has practiced there for 22 years after completing residency.*
...
The following table presents estimated characteristics of independent rural physician practices across different contexts:

| Practice | State | Type | Physician Count | Estimated Revenue | Ownership Structure | Payer Mix (Medicare/Medicaid/Commercial) | RHTP Connection | Transformation Capacity |
|----------|-------|------|-----------------|-------------------|---------------------|------------------------------------------|-----------------|------------------------|
| Garrison Family Practice | NE | Solo | 1 | $450K | Physician-owned | 65/15/20 | None | None; succession crisis |
| Moberly Family Medicine | MO | Solo | 1 | $620K | Physician-owned | 58/22/20 | None | Limited; ancillary dependent |
| Prairie Health Associates | IA | Small group | 4 | $2.4M | Physician partnership | 52/18/30 | ACO exploration | Moderate through scale |
| Mountain View Medical | MT | Solo (RHC) | 1 | $380K | Physician-owned RHC | 62/18/20 | RHTP subrecipient through state | Limited; retirement pending |
| Delta Family Physicians | MS | Small group | 3 | $1.8M | Physician partnership | 68/24/8 | None | Very limited; Medicaid underpayment |
| Central Kansas Primary Care | KS | Solo (RHC) | 2 | $890K | Physician-owned RHC | 64/16/20 | Flex Program TA | Moderate |
| High Plains Family Practice | TX | Solo | 1 | $510K | Physician-owned | 70/10/20 | None | None; financial distress |
| Upstate Rural Medicine | NY | Small group | 3 | $2.1M | Physician partnership | 48/28/24 | FQHC collaboration discussion | Potential through conversion |
...
For struggling independent physicians, employment represents escape rather than defeat:
...
**A competing perspective argues that independent rural physicians face impossible circumstances** that make transformation expectations unreasonable. These physicians manage patient loads that would require multiple providers in urban settings. They handle administrative burdens without staff support. They provide services at reimbursement rates below cost. They maintain 24/7 availability for communities that depend on them.
...
RHTP's design assumes organizational recipients with capacity to receive funds, implement programs, and report outcomes. Independent physician practices lack this capacity:
...
For independent physicians to participate meaningfully in rural health transformation:
...
This view **correctly identifies that ownership creates systematic incentive differences**. Research consistently finds practice pattern variations correlated with ownership: for-profit ownership associates with higher utilization, private equity ownership with cost reduction affecting quality, and physician ownership with self-referral. These patterns represent statistical tendencies, not universal laws.
...
Limited conditions enable independent practice transformation:
...
Certain conditions preclude transformation regardless of policy intervention:
...
**Extend technical assistance to independent practices.** Current TA through Flex Programs targets facilities rather than practices. Expanding eligibility and designing practice-appropriate resources could reach independent physicians who currently lack any transformation support.
...
**Address fee schedule adequacy.** Independent practice sustainability requires fee schedule updates that at minimum maintain purchasing power over time. The current trajectory guarantees continued independent practice decline.
...
**Pursue RHC certification where eligible.** The enhanced payment, regulatory protections, and program connections outweigh certification burdens for most eligible practices.
...
## Transition to Series 7 Synthesis

Independent physicians represent the most disaggregated provider category examined in this series. Unlike hospitals organized around facilities, health centers governed by community boards, or systems coordinating multiple sites, **independent practices are individuals making individual decisions in individual communities.**

The transformation question for independent physicians is whether this disaggregation can survive. RHTP assumes organizations that can receive funds, implement programs, and coordinate care. The administrative infrastructure of rural health transformation has no obvious place for solo practitioners managing their own practices while providing patient care.

The Series 7 synthesis will examine whether rural providers across categories can actually transform given financial constraints, workforce limitations, and structural barriers. Independent physicians illustrate the limits of transformation expectations imposed on providers whose survival consumes all available capacity. They also illustrate the accountability gap that organizational employment addresses, however imperfectly.

**The question this article raises but cannot answer:** Should policy preserve independent practice as a care delivery model, or should it accelerate transition to employed, organized, networked structures that better fit transformation infrastructure? The answer depends on values as much as evidence. What is lost when the last generalist in Garrison retires, and what is gained when care transitions to systems designed for accountability rather than autonomy?

## Cross-References

**Series 2: Federal Policy Architecture**
- [Article 2C](/rural-health/series-2/article-2c-medicare-rural-provisions/): Medicare Rural Provisions (fee schedule mechanics, RHC payment)

**Series 3: State Implementation Profiles**
- State profiles addressing primary care workforce (multiple states)

**Series 4: Transformation Approaches**
- [Article 4B](/rural-health/series-4/rhtp-4b-workforce-recruitment-and-retention/): Workforce (physician recruitment and retention)
- [Article 4C](/rural-health/series-4/rhtp-4c-telehealth-and-virtual-care/): Telehealth and Virtual Care (independent practice applications)

**Series 7: Healthcare Providers**
- [Article 7B](/rural-health/series-7/rhtp-7b/): Rural Health Clinics (overlapping provider population)
- TD-B: Provider Reimbursement Comparison Matrix (fee schedule details)

## Sources

Physicians Advocacy Institute and Avalere. "Rural Physician Employment and Acquisition Trends: 2019-2024." April 2025. https://www.physiciansadvocacyinstitute.org/PAI-Research/Rural-Physician-Employment-and-Acquisition-Trends-2019-2024.

American Medical Association. "How an Aging Nation and COVID-19 Stretch the Doctor Workforce Thin." April 2022. https://www.ama-assn.org/practice-management/sustainability/how-aging-nation-covid-19-stretch-doctor-workforce-thin.

Federation of State Medical Boards. "2022 Physician Census." FSMB, 2022. https://www.fsmb.org/siteassets/advocacy/publications/2022-physician-census.pdf.

Medicare Payment Advisory Commission. "Addressing the Growth of Ancillary Services in Physicians' Offices." Chapter 8 in Report to the Congress: Medicare Payment Policy. June 2010.

National Rural Health Association. "Rural Physician Burnout and Staffing Shortage Impact in 2025." June 2025. https://www.ruralhealth.us/blogs/2025/06/rural-physician-burnout-and-staffing-shortage-impact-in-2025.

American Medical Association. "AMA Outlines 5 Keys to Fixing America's Rural Health Crisis." June 2024. https://www.ama-assn.org/delivering-care/population-care/ama-outlines-5-keys-fixing-america-s-rural-health-crisis.

Petterson, Stephen, et al. "When Do Primary Care Physicians Retire? Implications for Workforce Projections." Annals of Family Medicine, vol. 14, no. 4, 2016, pp. 344-349.

Skinner, Lucy, et al. "Implications of an Aging Rural Physician Workforce." New England Journal of Medicine, vol. 381, July 2019, pp. 299-301.

Klink, Kristine. "Physician and Advanced Practice Clinician Burnout in Rural and Urban Settings." Journal of the American Board of Family Medicine, vol. 37, no. 1, 2024, pp. 43-54.

Rural Health Information Hub. "Rural Healthcare Payment and Reimbursement Overview." Accessed January 2026. https://www.ruralhealthinfo.org/topics/healthcare-payment.

Conrad, Douglas A., et al. "Primary Care Physicians' Experience of Financial Incentives in Managed-Care Systems." New England Journal of Medicine, vol. 339, 1998, pp. 1516-1521.

County Health Rankings and Roadmaps. "Financial Incentives for Health Professionals Serving Underserved Areas." University of Wisconsin Population Health Institute. https://www.countyhealthrankings.org/strategies-and-solutions/what-works-for-health/strategies/financial-incentives-for-health-professionals-serving-underserved-areas.
